...
{  
    ...
    HI_BOOL bMultiLightSourceEn;                        /*If enabled, some works will be done in multi light source enviroment*/ 
    ...
    HI_U16  au16MultiCTBin[8];                          /*AWB Support divide the color temperature range to 8 bins*/

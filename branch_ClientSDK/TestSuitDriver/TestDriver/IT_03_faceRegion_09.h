...
#ifndef IT_03_faceRegion_09_H
#define IT_03_faceRegion_09_H

#include "Driver.h"


class IT_03_faceRegion_09:public Driver
{
	public: 
		
		IT_03_faceRegion_09( unsigned int nCaseId );
		virtual int init();
		virtual int run();
		int initDetectCfgInfo(int DetectThreshold);
		virtual int uninit();

		virtual ~IT_03_faceRegion_09();
		void initRegion();

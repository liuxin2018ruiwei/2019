...
#ifndef IT_02_detectFace_05_H
#define IT_02_detectFace_05_H

#include "Driver.h"


class IT_02_detectFace_05:public Driver
{
	public: 
		
		IT_02_detectFace_05( unsigned int nCaseId );
		virtual int init();
		virtual int run();
		int initDetectCfgInfo(int DetectThreshold);
		virtual int uninit();

		virtual ~IT_02_detectFace_05();
		void initRegion();

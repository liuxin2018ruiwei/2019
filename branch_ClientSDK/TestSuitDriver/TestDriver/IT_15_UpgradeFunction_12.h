/********************************************************************
* Name      :  IT_15_UpgradeFunction_12.h                                  
* Param     :                                                        
* Return    :                                                        
* Describ   :                                                        
* Author    :  liuixn                                         
...
#ifndef IT_15_UpgradeFunction_12_H
#define IT_15_UpgradeFunction_12_H

#include "Driver.h"


class IT_15_UpgradeFunction_12:public Driver
{
	public: 
		
		IT_15_UpgradeFunction_12( unsigned int nCaseId );
		virtual int init();
		virtual int run();
		int initDetectCfgInfo(int DetectThreshold);
		virtual int uninit();

		virtual ~IT_15_UpgradeFunction_12();
		void initRegion();

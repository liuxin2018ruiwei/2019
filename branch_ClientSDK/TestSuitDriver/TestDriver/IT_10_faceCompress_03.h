...
#ifndef IT_10_faceCompress_03_H
#define IT_10_faceCompress_03_H
...
class IT_10_faceCompress_03:public Driver
{
	public: 
		
		IT_10_faceCompress_03( unsigned int nCaseId );
		virtual int init();
		virtual int run();
		int initDetectCfgInfo(int DetectThreshold);
		virtual int uninit();

		virtual ~IT_10_faceCompress_03();
		void initRegion();

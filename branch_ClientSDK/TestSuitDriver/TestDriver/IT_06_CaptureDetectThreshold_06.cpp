/********************************************************************
* Name      :  IT_06_CaptureDetectThreshold_06.cpp                                  
* Param     :                                                        
* Return    :                                                        
* Describ   :                                                        
* Author    :  Liu Xin                                          
...
int IT_06_CaptureDetectThreshold_06::init_initDetectFaceIF()
{
...
int IT_06_CaptureDetectThreshold_06:: init_pCallBackInfo()
{
...
IT_06_CaptureDetectThreshold_06::IT_06_CaptureDetectThreshold_06(unsigned int nCaseId ): Driver( nCaseId )
{

}

int IT_06_CaptureDetectThreshold_06::init()
{
...
/*
void IT_06_CaptureDetectThreshold_06::testCallbackSetLineF( RWNotifyType *pNotifyType, UINT8 *pExtData, UINT32 *pDataLen )
{
...
void IT_06_CaptureDetectThreshold_06::setline()
{
...
void IT_06_CaptureDetectThreshold_06::mySetDetectCfg()
{
	int ret32 = 0;
	DetectCfg cfgData;
...
void IT_06_CaptureDetectThreshold_06::addRegion()
{
	int nCount ; 
	nCount = 4; 
	Point tempPoint1[4];
...
void IT_06_CaptureDetectThreshold_06::writeInt32(char* data, int value)
{
...
void  IT_06_CaptureDetectThreshold_06::myAddFrame()
{
	int ret32 = 0;
	int width = 1920;
	int heigth = 1080;
...
void IT_06_CaptureDetectThreshold_06::initHeatBeat()
{
	int ret32 = 0;
	DetectCfg cfgData;
...
void IT_06_CaptureDetectThreshold_06::initDetectFace()
{
	int ret32 = 0;
	DetectCfg cfgData;
...
int IT_06_CaptureDetectThreshold_06::faceSize(UINT16 faceSizeValue)
{
	int ret32 = 0;
	DetectCfg cfgData;
...
int IT_06_CaptureDetectThreshold_06:: faceDetectCapture(int type)
{
	int ret32 = 0;
	DetectCfg cfgData;
	cfgData.ConfigMask = 0x01;
...
int IT_06_CaptureDetectThreshold_06::faceDetectThreshold(int value)
{
	int ret32 = 0;
	DetectCfg cfgData;
...
int IT_06_CaptureDetectThreshold_06::run()
{	
	int ret32 = 0;
	int width = 1920;
	int heigth = 1080;
...
int IT_06_CaptureDetectThreshold_06::uninit()
{
	Driver::uninit();
}

IT_06_CaptureDetectThreshold_06::~IT_06_CaptureDetectThreshold_06()
{
...
void IT_06_CaptureDetectThreshold_06::usrCallbackReplyCancalClient2(UINT64 *pReqID,
											  UINT8 *pRet,
											  UINT8 *pReplyData,
											  UINT32 *pDataLen )
{
...
void IT_06_CaptureDetectThreshold_06::usrCallbackReplyRegisterClient2(UINT64 *pReqID,
												UINT8 *pRet,
												UINT8 *pReplyData,
												UINT32 *pDataLen )
{
...
void IT_06_CaptureDetectThreshold_06::usrCallbackNotifyServiceInfo2( RWNotifyType *pNotifyType,
											   UINT8 *pExtData,
											   UINT32 *pDataLen)
{
...
void IT_06_CaptureDetectThreshold_06::usrCallbackNotifyFaceInfo2( RWNotifyType *pNotifyType,
											UINT8 *pExtData,
											UINT32 *pDataLen )
{

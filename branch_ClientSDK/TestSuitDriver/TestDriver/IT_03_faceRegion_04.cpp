...
int IT_03_faceRegion_04::init_initDetectFaceIF()
{
...
int IT_03_faceRegion_04:: init_pCallBackInfo()
{
...
IT_03_faceRegion_04::IT_03_faceRegion_04(unsigned int nCaseId ): Driver( nCaseId )
{

}

int IT_03_faceRegion_04::init()
{
...
void testCallbackSetLine4( RWNotifyType *pNotifyType, UINT8 *pExtData, UINT32 *pDataLen )
{
...
void IT_03_faceRegion_04::setline()
{
	CallbackNotifyFunc pFunc = testCallbackSetLine4;
	Line line3;
	line3.Head.X = 0;
	line3.Head.Y = 20;
	line3.End.X = 1000;
...
void IT_03_faceRegion_04::mySetDetectCfg()
{
	int ret32 = 0;
	DetectCfg cfgData;
...
void IT_03_faceRegion_04::addRegion()
{
	int nCount ; 
	nCount = 4; 
	Point tempPoint1[4];
...
void IT_03_faceRegion_04::writeInt32(char* data, int value)
{
...
void  IT_03_faceRegion_04::myAddFrame()
{
	int ret32 = 0;
	int width = 1920;
	int heigth = 1080;
...
int IT_03_faceRegion_04::uninit()
{
	Driver::uninit();
}

IT_03_faceRegion_04::~IT_03_faceRegion_04()
{
...
void IT_03_faceRegion_04::usrCallbackReplyCancalClient2(UINT64 *pReqID,
											  UINT8 *pRet,
											  UINT8 *pReplyData,
											  UINT32 *pDataLen )
{
...
void IT_03_faceRegion_04::usrCallbackReplyRegisterClient2(UINT64 *pReqID,
												UINT8 *pRet,
												UINT8 *pReplyData,
												UINT32 *pDataLen )
{
...
void IT_03_faceRegion_04::usrCallbackNotifyServiceInfo2( RWNotifyType *pNotifyType,
											   UINT8 *pExtData,
											   UINT32 *pDataLen)
{
...
void IT_03_faceRegion_04::usrCallbackNotifyFaceInfo2( RWNotifyType *pNotifyType,
											UINT8 *pExtData,
											UINT32 *pDataLen )
{

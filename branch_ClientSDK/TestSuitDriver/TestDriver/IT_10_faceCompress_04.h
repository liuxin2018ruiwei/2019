...
#ifndef IT_10_faceCompress_04_H
#define IT_10_faceCompress_04_H
...
class IT_10_faceCompress_04:public Driver
{
	public: 
		
		IT_10_faceCompress_04( unsigned int nCaseId );
		virtual int init();
		virtual int run();
		int initDetectCfgInfo(int DetectThreshold);
		virtual int uninit();

		virtual ~IT_10_faceCompress_04();
		void initRegion();

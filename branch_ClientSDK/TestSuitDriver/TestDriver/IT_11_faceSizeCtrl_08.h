...
#ifndef IT_11_faceSizeCtrl_08_H
#define IT_11_faceSizeCtrl_08_H
...
class IT_11_faceSizeCtrl_08:public Driver
{
	public: 
		
		IT_11_faceSizeCtrl_08( unsigned int nCaseId );
		virtual int init();
		virtual int run();
		int initDetectCfgInfo(int DetectThreshold);
		virtual int uninit();

		virtual ~IT_11_faceSizeCtrl_08();
		void initRegion();

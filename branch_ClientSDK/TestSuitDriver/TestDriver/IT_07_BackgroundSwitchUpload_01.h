/********************************************************************
* Name      :  IT_07_BackgroundSwitchUpload_01.h                                  
* Param     :                                                        
* Return    :                                                        
* Describ   :                                                        
* Author    :  liuixn                                         
...
#ifndef IT_07_BackgroundSwitchUpload_01_H
#define IT_07_BackgroundSwitchUpload_01_H
...
class IT_07_BackgroundSwitchUpload_01:public Driver
{
	public: 
		
		IT_07_BackgroundSwitchUpload_01( unsigned int nCaseId );
		virtual int init();
		virtual int run();
		int initDetectCfgInfo(int DetectThreshold);
		virtual int uninit();

		virtual ~IT_07_BackgroundSwitchUpload_01();
		void initRegion();

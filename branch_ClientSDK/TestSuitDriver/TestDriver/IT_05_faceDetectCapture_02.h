/********************************************************************
* Name      :  IT_05_faceDetectCapture_02.h                                  
* Param     :                                                        
* Return    :                                                        
* Describ   :                                                        
* Author    :  liuixn                                         
...
#ifndef IT_05_faceDetectCapture_02_H
#define IT_05_faceDetectCapture_02_H
...
class IT_05_faceDetectCapture_02:public Driver
{
	public: 
		
		IT_05_faceDetectCapture_02( unsigned int nCaseId );
		virtual int init();
		virtual int run();
		int initDetectCfgInfo(int DetectThreshold);
		virtual int uninit();

		virtual ~IT_05_faceDetectCapture_02();
		void initRegion();

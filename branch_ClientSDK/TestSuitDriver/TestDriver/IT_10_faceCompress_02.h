...
#ifndef IT_10_faceCompress_02_H
#define IT_10_faceCompress_02_H
...
class IT_10_faceCompress_02:public Driver
{
	public: 
		
		IT_10_faceCompress_02( unsigned int nCaseId );
		virtual int init();
		virtual int run();
		int initDetectCfgInfo(int DetectThreshold);
		virtual int uninit();

		virtual ~IT_10_faceCompress_02();
		void initRegion();

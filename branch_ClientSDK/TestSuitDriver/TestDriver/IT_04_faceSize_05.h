...
#ifndef IT_04_faceSize_05_H
#define IT_04_faceSize_05_H

#include "Driver.h"


class IT_04_faceSize_05:public Driver
{
	public: 
		
		IT_04_faceSize_05( unsigned int nCaseId );
		virtual int init();
		virtual int run();
		int initDetectCfgInfo(int DetectThreshold);
		virtual int uninit();

		virtual ~IT_04_faceSize_05();
		void initRegion();

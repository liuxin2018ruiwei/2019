...
#ifndef IT_08_FaceRectDraw_05_H
#define IT_08_FaceRectDraw_05_H
...
class IT_08_FaceRectDraw_05:public Driver
{
	public: 
		
		IT_08_FaceRectDraw_05( unsigned int nCaseId );
		virtual int init();
		virtual int run();
		int initDetectCfgInfo(int DetectThreshold);
		virtual int uninit();

		virtual ~IT_08_FaceRectDraw_05();
		void initRegion();

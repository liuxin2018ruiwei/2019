...
int IT_04_faceSize_04::init_initDetectFaceIF()
{
...
int IT_04_faceSize_04:: init_pCallBackInfo()
{
...
IT_04_faceSize_04::IT_04_faceSize_04(unsigned int nCaseId ): Driver( nCaseId )
{

}

int IT_04_faceSize_04::init()
{
...
/*
void IT_04_faceSize_04::testCallbackSetLineF( RWNotifyType *pNotifyType, UINT8 *pExtData, UINT32 *pDataLen )
{
...
void IT_04_faceSize_04::setline()
{
...
void IT_04_faceSize_04::mySetDetectCfg()
{
	int ret32 = 0;
	DetectCfg cfgData;
...
void IT_04_faceSize_04::addRegion()
{
	int nCount ; 
	nCount = 4; 
	Point tempPoint1[4];
...
void IT_04_faceSize_04::writeInt32(char* data, int value)
{
...
void  IT_04_faceSize_04::myAddFrame()
{
	int ret32 = 0;
	int width = 1920;
	int heigth = 1080;
...
void IT_04_faceSize_04::initHeatBeat()
{
	int ret32 = 0;
	DetectCfg cfgData;
...
void IT_04_faceSize_04::initDetectFace()
{
	int ret32 = 0;
	DetectCfg cfgData;
	...
	sleep(1);
	cfgData.DetectType = 1;
	printf("\n initDetectFace	open detect face \n");
	ret32 = setDetectConfig(m_TFHandle, &cfgData);
	if (ret32 == -1)
	{
	 	printf("setDetectConfig ERR \n");
	}
}

int IT_04_faceSize_04::faceSize(UINT16 faceSizeValue)
{
	int ret32 = 0;
	DetectCfg cfgData;
...
int IT_04_faceSize_04::uninit()
{
	Driver::uninit();
}

IT_04_faceSize_04::~IT_04_faceSize_04()
{
...
void IT_04_faceSize_04::usrCallbackReplyCancalClient2(UINT64 *pReqID,
											  UINT8 *pRet,
											  UINT8 *pReplyData,
											  UINT32 *pDataLen )
{
...
void IT_04_faceSize_04::usrCallbackReplyRegisterClient2(UINT64 *pReqID,
												UINT8 *pRet,
												UINT8 *pReplyData,
												UINT32 *pDataLen )
{
...
void IT_04_faceSize_04::usrCallbackNotifyServiceInfo2( RWNotifyType *pNotifyType,
											   UINT8 *pExtData,
											   UINT32 *pDataLen)
{
...
void IT_04_faceSize_04::usrCallbackNotifyFaceInfo2( RWNotifyType *pNotifyType,
											UINT8 *pExtData,
											UINT32 *pDataLen )
{

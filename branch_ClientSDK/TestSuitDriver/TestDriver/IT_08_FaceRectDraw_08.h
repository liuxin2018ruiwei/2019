...
#ifndef IT_08_FaceRectDraw_08_H
#define IT_08_FaceRectDraw_08_H
...
class IT_08_FaceRectDraw_08:public Driver
{
	public: 
		
		IT_08_FaceRectDraw_08( unsigned int nCaseId );
		virtual int init();
		virtual int run();
		int initDetectCfgInfo(int DetectThreshold);
		virtual int uninit();

		virtual ~IT_08_FaceRectDraw_08();
		void initRegion();

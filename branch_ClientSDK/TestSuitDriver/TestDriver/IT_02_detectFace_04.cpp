...
int IT_02_detectFace_04::init_initDetectFaceIF()
{
...
int IT_02_detectFace_04:: init_pCallBackInfo()
{
...
IT_02_detectFace_04::IT_02_detectFace_04(unsigned int nCaseId ): Driver( nCaseId )
{

}

int IT_02_detectFace_04::init()
{
...
{	
	...
	printf("\n IT_02_detectFace_04  open detect face \n");
	ret32 = setDetectConfig(m_TFHandle, &cfgData);
	...
	cfgData.DetectType = 1;
	printf("\n IT_02_detectFace_04  close detect face \n");
	ret32 = setDetectConfig(m_TFHandle, &cfgData);
...
int IT_02_detectFace_04::uninit()
{
	Driver::uninit();
}

IT_02_detectFace_04::~IT_02_detectFace_04()
{
...
void IT_02_detectFace_04::usrCallbackReplyCancalClient2(UINT64 *pReqID,
											  UINT8 *pRet,
											  UINT8 *pReplyData,
											  UINT32 *pDataLen )
{
...
void IT_02_detectFace_04::usrCallbackReplyRegisterClient2(UINT64 *pReqID,
												UINT8 *pRet,
												UINT8 *pReplyData,
												UINT32 *pDataLen )
{
...
void IT_02_detectFace_04::usrCallbackNotifyServiceInfo2( RWNotifyType *pNotifyType,
											   UINT8 *pExtData,
											   UINT32 *pDataLen)
{
	printf("---the notify CLIENT INFO type=%d, datalen=%d", *pNotifyType, *pDataLen );
}
void IT_02_detectFace_04::usrCallbackNotifyFaceInfo2( RWNotifyType *pNotifyType,
											UINT8 *pExtData,
											UINT32 *pDataLen )
{

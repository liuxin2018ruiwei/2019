/********************************************************************
* Name      :  IT_05_faceDetectCapture_08.h                                  
* Param     :                                                        
* Return    :                                                        
* Describ   :                                                        
* Author    :  liuixn                                         
...
#ifndef IT_05_faceDetectCapture_08_H
#define IT_05_faceDetectCapture_08_H
...
class IT_05_faceDetectCapture_08:public Driver
{
	public: 
		
		IT_05_faceDetectCapture_08( unsigned int nCaseId );
		virtual int init();
		virtual int run();
		int initDetectCfgInfo(int DetectThreshold);
		virtual int uninit();

		virtual ~IT_05_faceDetectCapture_08();
		void initRegion();

/********************************************************************
* Name      :  IT_06_CaptureDetectThreshold_10.h                                  
* Param     :                                                        
* Return    :                                                        
* Describ   :                                                        
* Author    :  liuixn                                         
...
#ifndef IT_06_CaptureDetectThreshold_10_H
#define IT_06_CaptureDetectThreshold_10_H
...
class IT_06_CaptureDetectThreshold_10:public Driver
{
	public: 
		
		IT_06_CaptureDetectThreshold_10( unsigned int nCaseId );
		virtual int init();
		virtual int run();
		int initDetectCfgInfo(int DetectThreshold);
		virtual int uninit();

		virtual ~IT_06_CaptureDetectThreshold_10();
		void initRegion();

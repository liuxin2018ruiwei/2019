...
#ifndef IT_12_ModleShow_06_H
#define IT_12_ModleShow_06_H
...
class IT_12_ModleShow_06:public Driver
{
	public: 
		
		IT_12_ModleShow_06( unsigned int nCaseId );
		virtual int init();
		virtual int run();
		int initDetectCfgInfo(int DetectThreshold);
		virtual int uninit();

		virtual ~IT_12_ModleShow_06();
		void initRegion();

...
#ifndef IT_11_faceSizeCtrl_05_H
#define IT_11_faceSizeCtrl_05_H
...
class IT_11_faceSizeCtrl_05:public Driver
{
	public: 
		
		IT_11_faceSizeCtrl_05( unsigned int nCaseId );
		virtual int init();
		virtual int run();
		int initDetectCfgInfo(int DetectThreshold);
		virtual int uninit();

		virtual ~IT_11_faceSizeCtrl_05();
		void initRegion();

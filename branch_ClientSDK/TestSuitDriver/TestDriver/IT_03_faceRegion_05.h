...
#ifndef IT_03_faceRegion_05_H
#define IT_03_faceRegion_05_H

#include "Driver.h"


class IT_03_faceRegion_05:public Driver
{
	public: 
		
		IT_03_faceRegion_05( unsigned int nCaseId );
		virtual int init();
		virtual int run();
		int initDetectCfgInfo(int DetectThreshold);
		virtual int uninit();

		virtual ~IT_03_faceRegion_05();
		void initRegion();

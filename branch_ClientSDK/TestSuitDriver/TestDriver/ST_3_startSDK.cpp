...
int ST_3_startSDK::init_initDetectFaceIF()
{
...
int ST_3_startSDK:: init_pCallBackInfo()
{
...
ST_3_startSDK::ST_3_startSDK(unsigned int nCaseId ): Driver( nCaseId )
{

}

int ST_3_startSDK::init()
{
	init_initDetectFaceIF();
	//printf("init_initDetectFaceIF = ok!");
	init_pCallBackInfo();

	printf("ST_3_startSDK_1 \n");
	int ret32 = startSDK(NULL);
	if(ret32 < 0)
	{
		printf("ST_3_startSDK_1 OK\n");
	}else{
		printf("ST_3_startSDK_1 ERR \n\n");
	}

	printf("ST_3_startSDK_2 \n");
	ret32 = startSDK( m_TFHandle );
	if(0 == ret32 )
	{
		printf("ST_3_startSDK_2 OK\n");
	}else{
		printf("ST_3_startSDK_2 ERR \n\n");
	}
	return 0;
}


int ST_3_startSDK::run()
{
	int ret32 = 0;
...
int ST_3_startSDK::uninit()
{
	Driver::uninit();
}

ST_3_startSDK::~ST_3_startSDK()
{
...
void ST_3_startSDK::usrCallbackReplyCancalClient1(UINT64 *pReqID,
											  UINT8 *pRet,
											  UINT8 *pReplyData,
											  UINT32 *pDataLen )
{
...
void ST_3_startSDK::usrCallbackReplyRegisterClient1(UINT64 *pReqID,
												UINT8 *pRet,
												UINT8 *pReplyData,
												UINT32 *pDataLen )
{
...
void ST_3_startSDK::usrCallbackNotifyServiceInfo1( RWNotifyType *pNotifyType,
											   UINT8 *pExtData,
											   UINT32 *pDataLen)
{
	//printf("---the notify CLIENT INFO type=%d, datalen=%d", *pNotifyType, *pDataLen );
}
void ST_3_startSDK::usrCallbackNotifyFaceInfo1( RWNotifyType *pNotifyType,
											UINT8 *pExtData,
											UINT32 *pDataLen )
{

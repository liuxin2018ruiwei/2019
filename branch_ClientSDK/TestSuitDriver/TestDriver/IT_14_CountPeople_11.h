...
#ifndef IT_14_CountPeople_11_H
#define IT_14_CountPeople_11_H
...
class IT_14_CountPeople_11:public Driver
{
	public: 
		
		IT_14_CountPeople_11( unsigned int nCaseId );
		virtual int init();
		virtual int run();
		int initDetectCfgInfo(int DetectThreshold);
		virtual int uninit();

		virtual ~IT_14_CountPeople_11();
		void initRegion();

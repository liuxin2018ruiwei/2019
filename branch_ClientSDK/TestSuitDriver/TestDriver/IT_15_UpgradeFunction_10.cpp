/********************************************************************
* Name      :  IT_15_UpgradeFunction_10.cpp                                  
* Param     :                                                        
* Return    :                                                        
* Describ   :                                                        
* Author    :  Liu Xin                                          
...
int IT_15_UpgradeFunction_10::init_initDetectFaceIF()
{
...
int IT_15_UpgradeFunction_10:: init_pCallBackInfo()
{
...
IT_15_UpgradeFunction_10::IT_15_UpgradeFunction_10(unsigned int nCaseId ): Driver( nCaseId )
{

}

int IT_15_UpgradeFunction_10::init()
{
...
void IT_15_UpgradeFunction_10_CallBackUpgrade(UINT64 *pReqID, UINT8 *pRet, UINT8 *pReplyData,UINT32 *pDataLen )
{
	UpgradeReqType getReplyData  =*((UpgradeReqType *) pReplyData);
	printf("13getReplyData = %d\n",getReplyData);
	if(0  == getReplyData)
	{
...
int IT_15_UpgradeFunction_10::upgradeAppCfg()
{
	int ret32 = 0;
	...
	CallbackReplyFunc pFuncTest = IT_15_UpgradeFunction_10_CallBackUpgrade; 
	printf("\n%x\n",pFuncTest);
...
int IT_15_UpgradeFunction_10::upgradeAppPkg()
{
	int ret32 = 0;
...
int IT_15_UpgradeFunction_10::upgradeCamereaQSPI()
{
	int ret32 = 0;
...
int IT_15_UpgradeFunction_10::getpDataCfgInfo( )
{
...
void IT_15_UpgradeFunction_10::qurySoftVersion()
{
...
void IT_15_UpgradeFunction_10::initHeatBeat()
{
	int ret32 = 0;
	DetectCfg cfgData;
...
void IT_15_UpgradeFunction_10::mySetDetectCfg()
{
	int ret32 = 0;
	DetectCfg cfgData;
...
void testCallbackSetLine_IT_15_UpgradeFunction_10( RWNotifyType *pNotifyType, UINT8 *pExtData, UINT32 *pDataLen )
{
...
void IT_15_UpgradeFunction_10::writeInt32(char* data, int value)
{
...
void IT_15_UpgradeFunction_10::setline()
{
	CallbackNotifyFunc pFunc = testCallbackSetLine_IT_15_UpgradeFunction_10;
	Line line3;
	line3.Head.X = 0;
	line3.Head.Y = 440;
	line3.End.X = 1920;
...
int IT_15_UpgradeFunction_10::faceSize(UINT16 faceSizeValue)
{
	int ret32 = 0;
	DetectCfg cfgData;
...
void IT_15_UpgradeFunction_10::initDetectFace()
{
	int ret32 = 0;
	DetectCfg cfgData;
...
void IT_15_UpgradeFunction_10::addRegion()
{
	int nCount ; 
	nCount = 4; 
	Point tempPoint1[4];
...
int IT_15_UpgradeFunction_10:: faceDetectCapture(int type)
{
	int ret32 = 0;
	DetectCfg cfgData;
	cfgData.ConfigMask = 0x01;
...
int IT_15_UpgradeFunction_10::setFaceCtrl(UINT8 faceData)
{
	int ret32 = 0;
	DetectCfg cfgData;
...
void IT_15_UpgradeFunction_10::backGroundPicSwith(UINT8 data)
{
	int ret32 = 0;
	DetectCfg cfgData;
...
int IT_15_UpgradeFunction_10::faceDetectThreshold(int value)
{
	int ret32 = 0;
	DetectCfg cfgData;
...
void  IT_15_UpgradeFunction_10::myAddFrame()
{
	int ret32 = 0;
	int width = 1920;
	int heigth = 1080;
...
int IT_15_UpgradeFunction_10::run()
{
	sleep(2);
...
int IT_15_UpgradeFunction_10::uninit()
{
	Driver::uninit();
}

IT_15_UpgradeFunction_10::~IT_15_UpgradeFunction_10()
{
...
void IT_15_UpgradeFunction_10::usrCallbackReplyCancalClient1(UINT64 *pReqID,
											  UINT8 *pRet,
											  UINT8 *pReplyData,
											  UINT32 *pDataLen )
{
...
void IT_15_UpgradeFunction_10::usrCallbackReplyRegisterClient1(UINT64 *pReqID,
												UINT8 *pRet,
												UINT8 *pReplyData,
												UINT32 *pDataLen )
{
...
void IT_15_UpgradeFunction_10::usrCallbackNotifyServiceInfo1( RWNotifyType *pNotifyType,
											   UINT8 *pExtData,
											   UINT32 *pDataLen)
{
	//printf("---the notify CLIENT INFO type=%d, datalen=%d", *pNotifyType, *pDataLen );
}
void IT_15_UpgradeFunction_10::usrCallbackNotifyFaceInfo1( RWNotifyType *pNotifyType,
											UINT8 *pExtData,
											UINT32 *pDataLen )
{

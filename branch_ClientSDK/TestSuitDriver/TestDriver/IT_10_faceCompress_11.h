...
#ifndef IT_10_faceCompress_11_H
#define IT_10_faceCompress_11_H
...
class IT_10_faceCompress_11:public Driver
{
	public: 
		
		IT_10_faceCompress_11( unsigned int nCaseId );
		virtual int init();
		virtual int run();
		int initDetectCfgInfo(int DetectThreshold);
		virtual int uninit();

		virtual ~IT_10_faceCompress_11();
		void initRegion();

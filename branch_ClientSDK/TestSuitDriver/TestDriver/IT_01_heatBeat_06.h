...
#ifndef IT_01_heatBeat_06_H
#define IT_01_heatBeat_06_H

#include "Driver.h"


class IT_01_heatBeat_06:public Driver
{
	public: 
		
		IT_01_heatBeat_06( unsigned int nCaseId );
		virtual int init();
		virtual int run();
		int initDetectCfgInfo(int DetectThreshold);
		virtual int uninit();

		virtual ~IT_01_heatBeat_06();
		void initRegion();

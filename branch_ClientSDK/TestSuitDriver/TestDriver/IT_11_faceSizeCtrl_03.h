...
#ifndef IT_11_faceSizeCtrl_03_H
#define IT_11_faceSizeCtrl_03_H
...
class IT_11_faceSizeCtrl_03:public Driver
{
	public: 
		
		IT_11_faceSizeCtrl_03( unsigned int nCaseId );
		virtual int init();
		virtual int run();
		int initDetectCfgInfo(int DetectThreshold);
		virtual int uninit();

		virtual ~IT_11_faceSizeCtrl_03();
		void initRegion();

...
#ifndef IT_11_faceSizeCtrl_13_H
#define IT_11_faceSizeCtrl_13_H
...
class IT_11_faceSizeCtrl_13:public Driver
{
	public: 
		
		IT_11_faceSizeCtrl_13( unsigned int nCaseId );
		virtual int init();
		virtual int run();
		int initDetectCfgInfo(int DetectThreshold);
		virtual int uninit();

		virtual ~IT_11_faceSizeCtrl_13();
		void initRegion();

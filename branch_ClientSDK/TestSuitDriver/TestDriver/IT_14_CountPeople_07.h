...
#ifndef IT_14_CountPeople_07_H
#define IT_14_CountPeople_07_H
...
class IT_14_CountPeople_07:public Driver
{
	public: 
		
		IT_14_CountPeople_07( unsigned int nCaseId );
		virtual int init();
		virtual int run();
		int initDetectCfgInfo(int DetectThreshold);
		virtual int uninit();

		virtual ~IT_14_CountPeople_07();
		void initRegion();

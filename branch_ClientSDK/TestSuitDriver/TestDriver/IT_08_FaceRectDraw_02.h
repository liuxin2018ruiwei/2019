...
#ifndef IT_08_FaceRectDraw_02_H
#define IT_08_FaceRectDraw_02_H
...
class IT_08_FaceRectDraw_02:public Driver
{
	public: 
		
		IT_08_FaceRectDraw_02( unsigned int nCaseId );
		virtual int init();
		virtual int run();
		int initDetectCfgInfo(int DetectThreshold);
		virtual int uninit();

		virtual ~IT_08_FaceRectDraw_02();
		void initRegion();

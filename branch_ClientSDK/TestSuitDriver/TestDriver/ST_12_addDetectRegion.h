...
#ifndef ST_12_addDetectRegion_H
#define ST_12_addDetectRegion_H

#include "Driver.h"


class ST_12_addDetectRegion:public Driver
{
	public: 
		
		ST_12_addDetectRegion( unsigned int nCaseId );
		virtual int init();
		virtual int run();
		int initDetectCfgInfo(int DetectThreshold);
		virtual int uninit();

		virtual ~ST_12_addDetectRegion();
		void initRegion();

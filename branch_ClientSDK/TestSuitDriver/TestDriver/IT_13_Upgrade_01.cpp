...
int IT_13_Upgrade_01::init_initDetectFaceIF()
{
...
int IT_13_Upgrade_01:: init_pCallBackInfo()
{
...
IT_13_Upgrade_01::IT_13_Upgrade_01(unsigned int nCaseId ): Driver( nCaseId )
{

}

int IT_13_Upgrade_01::init()
{
...
void IT_13_Upgrade_01_CallBackUpgrade(UINT64 *pReqID, UINT8 *pRet, UINT8 *pReplyData,UINT32 *pDataLen )
{
	UINT8 getReplyData  =*pReplyData;
	int data = getReplyData;
	printf("IT_13_Upgrade_01_CallBackUpgrade --->getReplyData = %d, %X\n",data, getReplyData);
	if(0  == getReplyData)
	{
...
int IT_13_Upgrade_01::upgradeAppCfgIT_13_Upgrade_01()
{
	int ret32 = 0;
	...
	UINT8 tempMD5[16] = { 		    0xef,0xfa,0x71,0xa7,
									0x0e,0xb1,0x4f,0xe7,
									0x52,0x9c,0xca,0xd5,
									0xba,0x0e,0x71,0xa6  };
	...
	pDataInfo->FileSize = 1402;//,0:app.cfg
	
	CallbackReplyFunc pFuncTest = IT_13_Upgrade_01_CallBackUpgrade; 
	printf("\n%x\n",pFuncTest);
...
int IT_13_Upgrade_01::upgradeAppPkg()
{
	int ret32 = 0;
...
int IT_13_Upgrade_01::upgradeCamereaQSPI()
{
	int ret32 = 0;
...
int IT_13_Upgrade_01::getpDataCfgInfo( )
{
...
void IT_13_Upgrade_01::qurySoftVersion()
{
...
void IT_13_Upgrade_01::initHeatBeat()
{
	int ret32 = 0;
	DetectCfg cfgData;
...
int IT_13_Upgrade_01::run()
{
	...
	sleep(1);
	upgradeAppCfgIT_13_Upgrade_01();

	printf("IT_13_Upgrade_01 upgradeAppPkg\n\n\n");
	//sleep(4);
	qurySoftVersion();
...
int IT_13_Upgrade_01::uninit()
{
	Driver::uninit();
}

IT_13_Upgrade_01::~IT_13_Upgrade_01()
{
...
void IT_13_Upgrade_01::usrCallbackReplyCancalClient1(UINT64 *pReqID,
											  UINT8 *pRet,
											  UINT8 *pReplyData,
											  UINT32 *pDataLen )
{
...
void IT_13_Upgrade_01::usrCallbackReplyRegisterClient1(UINT64 *pReqID,
												UINT8 *pRet,
												UINT8 *pReplyData,
												UINT32 *pDataLen )
{
...
void IT_13_Upgrade_01::usrCallbackNotifyServiceInfo1( RWNotifyType *pNotifyType,
											   UINT8 *pExtData,
											   UINT32 *pDataLen)
{
	//printf("---the notify CLIENT INFO type=%d, datalen=%d", *pNotifyType, *pDataLen );
}
void IT_13_Upgrade_01::usrCallbackNotifyFaceInfo1( RWNotifyType *pNotifyType,
											UINT8 *pExtData,
											UINT32 *pDataLen )
{

...
#ifndef IT_08_FaceRectDraw_06_H
#define IT_08_FaceRectDraw_06_H
...
class IT_08_FaceRectDraw_06:public Driver
{
	public: 
		
		IT_08_FaceRectDraw_06( unsigned int nCaseId );
		virtual int init();
		virtual int run();
		int initDetectCfgInfo(int DetectThreshold);
		virtual int uninit();

		virtual ~IT_08_FaceRectDraw_06();
		void initRegion();

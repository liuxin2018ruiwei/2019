/********************************************************************
* Name      :  IT_11_faceSizeCtrl_03.cpp                                  
* Param     :                                                        
* Return    :                                                        
* Describ   :                                                        
* Author    :  Liu Xin                                          
...
int IT_11_faceSizeCtrl_03::init_initDetectFaceIF()
{
...
int IT_11_faceSizeCtrl_03:: init_pCallBackInfo()
{
...
IT_11_faceSizeCtrl_03::IT_11_faceSizeCtrl_03(unsigned int nCaseId ): Driver( nCaseId )
{

}

int IT_11_faceSizeCtrl_03::init()
{
...
/*
void IT_11_faceSizeCtrl_03::testCallbackSetLineF( RWNotifyType *pNotifyType, UINT8 *pExtData, UINT32 *pDataLen )
{
...
void IT_11_faceSizeCtrl_03::setline()
{
...
void IT_11_faceSizeCtrl_03::mySetDetectCfg()
{
	int ret32 = 0;
	DetectCfg cfgData;
...
void IT_11_faceSizeCtrl_03::addRegion()
{
	int nCount ; 
	nCount = 4; 
	Point tempPoint1[4];
...
void IT_11_faceSizeCtrl_03::writeInt32(char* data, int value)
{
...
void  IT_11_faceSizeCtrl_03::myAddFrame()
{
	int ret32 = 0;
	int width = 1920;
	int heigth = 1080;
...
void IT_11_faceSizeCtrl_03::initHeatBeat()
{
	int ret32 = 0;
	DetectCfg cfgData;
...
void IT_11_faceSizeCtrl_03::initDetectFace()
{
	int ret32 = 0;
	DetectCfg cfgData;
...
int IT_11_faceSizeCtrl_03::faceSize(UINT16 faceSizeValue)
{
	int ret32 = 0;
	DetectCfg cfgData;
...
int IT_11_faceSizeCtrl_03:: faceDetectCapture(int type)
{
	int ret32 = 0;
	DetectCfg cfgData;
	cfgData.ConfigMask = 0x01;
...
void IT_11_faceSizeCtrl_03::backGroundPicSwith(UINT8 data)
{
	int ret32 = 0;
	DetectCfg cfgData;
...
int IT_11_faceSizeCtrl_03::faceDetectThreshold(int value)
{
	int ret32 = 0;
	DetectCfg cfgData;
...
int IT_11_faceSizeCtrl_03::setFaceCtrl(UINT8 faceData)
{
	int ret32 = 0;
	DetectCfg cfgData;
...
int IT_11_faceSizeCtrl_03::uninit()
{
	Driver::uninit();
}

IT_11_faceSizeCtrl_03::~IT_11_faceSizeCtrl_03()
{
...
void IT_11_faceSizeCtrl_03::usrCallbackReplyCancalClient2(UINT64 *pReqID,
											  UINT8 *pRet,
											  UINT8 *pReplyData,
											  UINT32 *pDataLen )
{
...
void IT_11_faceSizeCtrl_03::usrCallbackReplyRegisterClient2(UINT64 *pReqID,
												UINT8 *pRet,
												UINT8 *pReplyData,
												UINT32 *pDataLen )
{
...
void IT_11_faceSizeCtrl_03::usrCallbackNotifyServiceInfo2( RWNotifyType *pNotifyType,
											   UINT8 *pExtData,
											   UINT32 *pDataLen)
{
...
static int  IT_11_faceSizeCtrl_03_m_flag1;

void IT_11_faceSizeCtrl_03::usrCallbackNotifyFaceInfo2( RWNotifyType *pNotifyType,
											UINT8 *pExtData,
											UINT32 *pDataLen )
{
	...
	else if (NotifyImgData == getRWNotifyType)
	{
		...
		char picName[40]  = {0};
		snprintf(picName, 40, "/dev/lxPic_%d.jpg", IT_11_faceSizeCtrl_03_m_flag1++);

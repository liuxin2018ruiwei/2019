/********************************************************************
* Name      :  IT_09_BackPicCompress_01.h                                  
* Param     :                                                        
* Return    :                                                        
* Describ   :                                                        
* Author    :  liuixn                                         
...
#ifndef IT_09_BackPicCompress_01_H
#define IT_09_BackPicCompress_01_H
...
class IT_09_BackPicCompress_01:public Driver
{
	public: 
		
		IT_09_BackPicCompress_01( unsigned int nCaseId );
		virtual int init();
		virtual int run();
		int initDetectCfgInfo(int DetectThreshold);
		virtual int uninit();

		virtual ~IT_09_BackPicCompress_01();
		void initRegion();

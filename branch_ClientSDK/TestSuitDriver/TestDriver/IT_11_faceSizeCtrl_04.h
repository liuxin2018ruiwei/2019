...
#ifndef IT_11_faceSizeCtrl_04_H
#define IT_11_faceSizeCtrl_04_H
...
class IT_11_faceSizeCtrl_04:public Driver
{
	public: 
		
		IT_11_faceSizeCtrl_04( unsigned int nCaseId );
		virtual int init();
		virtual int run();
		int initDetectCfgInfo(int DetectThreshold);
		virtual int uninit();

		virtual ~IT_11_faceSizeCtrl_04();
		void initRegion();

...
#ifndef IT_12_ModleShow_09_H
#define IT_12_ModleShow_09_H
...
class IT_12_ModleShow_09:public Driver
{
	public: 
		
		IT_12_ModleShow_09( unsigned int nCaseId );
		virtual int init();
		virtual int run();
		int initDetectCfgInfo(int DetectThreshold);
		virtual int uninit();

		virtual ~IT_12_ModleShow_09();
		void initRegion();

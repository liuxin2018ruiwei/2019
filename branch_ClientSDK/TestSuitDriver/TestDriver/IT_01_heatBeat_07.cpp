...
int IT_01_heatBeat_07::init_initDetectFaceIF()
{
...
int IT_01_heatBeat_07:: init_pCallBackInfo()
{
...
IT_01_heatBeat_07::IT_01_heatBeat_07(unsigned int nCaseId ): Driver( nCaseId )
{

}

int IT_01_heatBeat_07::init()
{
...
{	
	...
	printf("IT_01_heatBeat_07 starting.... \n");
...
int IT_01_heatBeat_07::uninit()
{
	Driver::uninit();
}

IT_01_heatBeat_07::~IT_01_heatBeat_07()
{
...
void IT_01_heatBeat_07::usrCallbackReplyCancalClient1(UINT64 *pReqID,
											  UINT8 *pRet,
											  UINT8 *pReplyData,
											  UINT32 *pDataLen )
{
...
void IT_01_heatBeat_07::usrCallbackReplyRegisterClient1(UINT64 *pReqID,
												UINT8 *pRet,
												UINT8 *pReplyData,
												UINT32 *pDataLen )
{
...
void IT_01_heatBeat_07::usrCallbackNotifyServiceInfo1( RWNotifyType *pNotifyType,
											   UINT8 *pExtData,
											   UINT32 *pDataLen)
{
	printf("---the notify CLIENT INFO type=%d, datalen=%d", *pNotifyType, *pDataLen );
}
void IT_01_heatBeat_07::usrCallbackNotifyFaceInfo1( RWNotifyType *pNotifyType,
											UINT8 *pExtData,
											UINT32 *pDataLen )
{

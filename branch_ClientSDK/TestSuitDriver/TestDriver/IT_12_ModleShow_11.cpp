...
int IT_12_ModleShow_11::init_initDetectFaceIF()
{
...
int IT_12_ModleShow_11:: init_pCallBackInfo()
{
...
IT_12_ModleShow_11::IT_12_ModleShow_11(unsigned int nCaseId ): Driver( nCaseId )
{

}

int IT_12_ModleShow_11::init()
{
...
/*
void IT_12_ModleShow_11::testCallbackSetLineF( RWNotifyType *pNotifyType, UINT8 *pExtData, UINT32 *pDataLen )
{
...
void IT_12_ModleShow_11::setline()
{
...
void IT_12_ModleShow_11::mySetDetectCfg()
{
	int ret32 = 0;
	DetectCfg cfgData;
...
void IT_12_ModleShow_11::addRegion()
{
	int nCount ; 
	nCount = 4; 
	Point tempPoint1[4];
...
void IT_12_ModleShow_11::writeInt32(char* data, int value)
{
...
void  IT_12_ModleShow_11::myAddFrame()
{
	int ret32 = 0;
	int width = 1920;
	int heigth = 1080;
...
void IT_12_ModleShow_11::initHeatBeat()
{
	int ret32 = 0;
	DetectCfg cfgData;
...
void IT_12_ModleShow_11::initDetectFace()
{
	int ret32 = 0;
	DetectCfg cfgData;
...
int IT_12_ModleShow_11::faceSize(UINT16 faceSizeValue)
{
	int ret32 = 0;
	DetectCfg cfgData;
...
int IT_12_ModleShow_11:: faceDetectCapture(int type)
{
	int ret32 = 0;
	DetectCfg cfgData;
	cfgData.ConfigMask = 0x01;
...
void IT_12_ModleShow_11::backGroundPicSwith(UINT8 data)
{
	int ret32 = 0;
	DetectCfg cfgData;
...
int IT_12_ModleShow_11::faceDetectThreshold(int value)
{
	int ret32 = 0;
	DetectCfg cfgData;
...
int IT_12_ModleShow_11::setFaceCtrl(UINT8 faceData)
{
	int ret32 = 0;
	DetectCfg cfgData;
...
void IT_12_ModleShow_11::qurySoftVersion()
{
...
int IT_12_ModleShow_11::uninit()
{
	Driver::uninit();
}

IT_12_ModleShow_11::~IT_12_ModleShow_11()
{
...
void IT_12_ModleShow_11::usrCallbackReplyCancalClient2(UINT64 *pReqID,
											  UINT8 *pRet,
											  UINT8 *pReplyData,
											  UINT32 *pDataLen )
{
...
void IT_12_ModleShow_11::usrCallbackReplyRegisterClient2(UINT64 *pReqID,
												UINT8 *pRet,
												UINT8 *pReplyData,
												UINT32 *pDataLen )
{
...
void IT_12_ModleShow_11::usrCallbackNotifyServiceInfo2( RWNotifyType *pNotifyType,
											   UINT8 *pExtData,
											   UINT32 *pDataLen)
{
...
static int  IT_12_ModleShow_11_m_flag1;

void IT_12_ModleShow_11::usrCallbackNotifyFaceInfo2( RWNotifyType *pNotifyType,
											UINT8 *pExtData,
											UINT32 *pDataLen )
{
	...
	else if (NotifyImgData == getRWNotifyType)
	{
		...
		char picName[40]  = {0};
		snprintf(picName, 40, "/dev/lxPic_%d.jpg", IT_12_ModleShow_11_m_flag1++);

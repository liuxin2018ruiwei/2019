...
#ifndef IT_14_CountPeople_06_H
#define IT_14_CountPeople_06_H
...
class IT_14_CountPeople_06:public Driver
{
	public: 
		
		IT_14_CountPeople_06( unsigned int nCaseId );
		virtual int init();
		virtual int run();
		int initDetectCfgInfo(int DetectThreshold);
		virtual int uninit();

		virtual ~IT_14_CountPeople_06();
		void initRegion();

/********************************************************************
* Name      :  IT_09_BackPicCompress_09.cpp                                  
* Param     :                                                        
* Return    :                                                        
* Describ   :                                                        
* Author    :  Liu Xin                                          
...
int IT_09_BackPicCompress_09::init_initDetectFaceIF()
{
...
int IT_09_BackPicCompress_09:: init_pCallBackInfo()
{
...
IT_09_BackPicCompress_09::IT_09_BackPicCompress_09(unsigned int nCaseId ): Driver( nCaseId )
{

}

int IT_09_BackPicCompress_09::init()
{
...
/*
void IT_09_BackPicCompress_09::testCallbackSetLineF( RWNotifyType *pNotifyType, UINT8 *pExtData, UINT32 *pDataLen )
{
...
void IT_09_BackPicCompress_09::setline()
{
...
void IT_09_BackPicCompress_09::mySetDetectCfg()
{
	int ret32 = 0;
	DetectCfg cfgData;
...
void IT_09_BackPicCompress_09::addRegion()
{
	int nCount ; 
	nCount = 4; 
	Point tempPoint1[4];
...
void IT_09_BackPicCompress_09::writeInt32(char* data, int value)
{
...
void  IT_09_BackPicCompress_09::myAddFrame()
{
	int ret32 = 0;
	int width = 1920;
	int heigth = 1080;
...
void IT_09_BackPicCompress_09::initHeatBeat()
{
	int ret32 = 0;
	DetectCfg cfgData;
...
void IT_09_BackPicCompress_09::initDetectFace()
{
	int ret32 = 0;
	DetectCfg cfgData;
...
int IT_09_BackPicCompress_09::faceSize(UINT16 faceSizeValue)
{
	int ret32 = 0;
	DetectCfg cfgData;
...
int IT_09_BackPicCompress_09:: faceDetectCapture(int type)
{
	int ret32 = 0;
	DetectCfg cfgData;
	cfgData.ConfigMask = 0x01;
...
void IT_09_BackPicCompress_09::backGroundPicSwith(UINT8 data)
{
	int ret32 = 0;
	DetectCfg cfgData;
...
int IT_09_BackPicCompress_09::faceDetectThreshold(int value)
{
	int ret32 = 0;
	DetectCfg cfgData;
...
int IT_09_BackPicCompress_09::run()
{	
	int ret32 = 0;
	int width = 1920;
	int heigth = 1080;
...
int IT_09_BackPicCompress_09::uninit()
{
	Driver::uninit();
}

IT_09_BackPicCompress_09::~IT_09_BackPicCompress_09()
{
...
void IT_09_BackPicCompress_09::usrCallbackReplyCancalClient2(UINT64 *pReqID,
											  UINT8 *pRet,
											  UINT8 *pReplyData,
											  UINT32 *pDataLen )
{
...
void IT_09_BackPicCompress_09::usrCallbackReplyRegisterClient2(UINT64 *pReqID,
												UINT8 *pRet,
												UINT8 *pReplyData,
												UINT32 *pDataLen )
{
...
void IT_09_BackPicCompress_09::usrCallbackNotifyServiceInfo2( RWNotifyType *pNotifyType,
											   UINT8 *pExtData,
											   UINT32 *pDataLen)
{
...
static int  IT_09_BackPicCompress_09_m_flag1;

void IT_09_BackPicCompress_09::usrCallbackNotifyFaceInfo2( RWNotifyType *pNotifyType,
											UINT8 *pExtData,
											UINT32 *pDataLen )
{
	...
	else if (NotifyImgData == getRWNotifyType)
	{
		...
		char picName[40]  = {0};
		snprintf(picName, 40, "/dev/lxPic_%d.jpg", IT_09_BackPicCompress_09_m_flag1++);

...
#ifndef IT_10_faceCompress_13_H
#define IT_10_faceCompress_13_H
...
class IT_10_faceCompress_13:public Driver
{
	public: 
		
		IT_10_faceCompress_13( unsigned int nCaseId );
		virtual int init();
		virtual int run();
		int initDetectCfgInfo(int DetectThreshold);
		virtual int uninit();

		virtual ~IT_10_faceCompress_13();
		void initRegion();

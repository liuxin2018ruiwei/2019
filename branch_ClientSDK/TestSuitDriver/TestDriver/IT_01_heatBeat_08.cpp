...
int IT_01_heatBeat_08::init_initDetectFaceIF()
{
...
int IT_01_heatBeat_08:: init_pCallBackInfo()
{
...
IT_01_heatBeat_08::IT_01_heatBeat_08(unsigned int nCaseId ): Driver( nCaseId )
{

}

int IT_01_heatBeat_08::init()
{
...
int IT_01_heatBeat_08::run()
{	
	int ret32 = 0;
	DetectCfg cfgData;
	cfgData.ConfigMask = 0x02;

	printf("\n\nIT_01_heatBeat_08_01\n");
	...
	printf("IT_01_heatBeat_08_01 starting.... \n");
...
int IT_01_heatBeat_08::uninit()
{
	Driver::uninit();
}

IT_01_heatBeat_08::~IT_01_heatBeat_08()
{
...
void IT_01_heatBeat_08::usrCallbackReplyCancalClient1(UINT64 *pReqID,
											  UINT8 *pRet,
											  UINT8 *pReplyData,
											  UINT32 *pDataLen )
{
...
void IT_01_heatBeat_08::usrCallbackReplyRegisterClient1(UINT64 *pReqID,
												UINT8 *pRet,
												UINT8 *pReplyData,
												UINT32 *pDataLen )
{
...
void IT_01_heatBeat_08::usrCallbackNotifyServiceInfo1( RWNotifyType *pNotifyType,
											   UINT8 *pExtData,
											   UINT32 *pDataLen)
{
	printf("---the notify CLIENT INFO type=%d, datalen=%d", *pNotifyType, *pDataLen );
}
void IT_01_heatBeat_08::usrCallbackNotifyFaceInfo1( RWNotifyType *pNotifyType,
											UINT8 *pExtData,
											UINT32 *pDataLen )
{

...
#ifndef IT_14_CountPeople_04_H
#define IT_14_CountPeople_04_H
...
class IT_14_CountPeople_04:public Driver
{
	public: 
		
		IT_14_CountPeople_04( unsigned int nCaseId );
		virtual int init();
		virtual int run();
		int initDetectCfgInfo(int DetectThreshold);
		virtual int uninit();

		virtual ~IT_14_CountPeople_04();
		void initRegion();

...
#ifndef IT_03_faceRegion_07_H
#define IT_03_faceRegion_07_H

#include "Driver.h"


class IT_03_faceRegion_07:public Driver
{
	public: 
		
		IT_03_faceRegion_07( unsigned int nCaseId );
		virtual int init();
		virtual int run();
		int initDetectCfgInfo(int DetectThreshold);
		virtual int uninit();

		virtual ~IT_03_faceRegion_07();
		void initRegion();

...
int IT_04_faceSize_02::init_initDetectFaceIF()
{
...
int IT_04_faceSize_02:: init_pCallBackInfo()
{
...
IT_04_faceSize_02::IT_04_faceSize_02(unsigned int nCaseId ): Driver( nCaseId )
{

}

int IT_04_faceSize_02::init()
{
...
/*
void IT_04_faceSize_02::testCallbackSetLineF( RWNotifyType *pNotifyType, UINT8 *pExtData, UINT32 *pDataLen )
{
...
void IT_04_faceSize_02::setline()
{
...
void IT_04_faceSize_02::mySetDetectCfg()
{
	int ret32 = 0;
	DetectCfg cfgData;
...
void IT_04_faceSize_02::addRegion()
{
	int nCount ; 
	nCount = 4; 
	Point tempPoint1[4];
...
void IT_04_faceSize_02::writeInt32(char* data, int value)
{
...
void  IT_04_faceSize_02::myAddFrame()
{
	int ret32 = 0;
	int width = 1920;
	int heigth = 1080;
...
void IT_04_faceSize_02::initHeatBeat()
{
	int ret32 = 0;
	DetectCfg cfgData;
...
void IT_04_faceSize_02::initDetectFace()
{
	int ret32 = 0;
	DetectCfg cfgData;
...
int IT_04_faceSize_02::faceSize(UINT16 faceSizeValue)
{
	int ret32 = 0;
	DetectCfg cfgData;
...
int IT_04_faceSize_02::uninit()
{
	Driver::uninit();
}

IT_04_faceSize_02::~IT_04_faceSize_02()
{
...
void IT_04_faceSize_02::usrCallbackReplyCancalClient2(UINT64 *pReqID,
											  UINT8 *pRet,
											  UINT8 *pReplyData,
											  UINT32 *pDataLen )
{
...
void IT_04_faceSize_02::usrCallbackReplyRegisterClient2(UINT64 *pReqID,
												UINT8 *pRet,
												UINT8 *pReplyData,
												UINT32 *pDataLen )
{
...
void IT_04_faceSize_02::usrCallbackNotifyServiceInfo2( RWNotifyType *pNotifyType,
											   UINT8 *pExtData,
											   UINT32 *pDataLen)
{
...
void IT_04_faceSize_02::usrCallbackNotifyFaceInfo2( RWNotifyType *pNotifyType,
											UINT8 *pExtData,
											UINT32 *pDataLen )
{

...
#ifndef IT_11_faceSizeCtrl_09_H
#define IT_11_faceSizeCtrl_09_H
...
class IT_11_faceSizeCtrl_09:public Driver
{
	public: 
		
		IT_11_faceSizeCtrl_09( unsigned int nCaseId );
		virtual int init();
		virtual int run();
		int initDetectCfgInfo(int DetectThreshold);
		virtual int uninit();

		virtual ~IT_11_faceSizeCtrl_09();
		void initRegion();

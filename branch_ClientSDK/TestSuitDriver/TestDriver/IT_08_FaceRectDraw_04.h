...
#ifndef IT_08_FaceRectDraw_04_H
#define IT_08_FaceRectDraw_04_H
...
class IT_08_FaceRectDraw_04:public Driver
{
	public: 
		
		IT_08_FaceRectDraw_04( unsigned int nCaseId );
		virtual int init();
		virtual int run();
		int initDetectCfgInfo(int DetectThreshold);
		virtual int uninit();

		virtual ~IT_08_FaceRectDraw_04();
		void initRegion();

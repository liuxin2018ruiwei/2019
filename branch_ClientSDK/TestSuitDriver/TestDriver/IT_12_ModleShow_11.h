...
#ifndef IT_12_ModleShow_11_H
#define IT_12_ModleShow_11_H
...
class IT_12_ModleShow_11:public Driver
{
	public: 
		
		IT_12_ModleShow_11( unsigned int nCaseId );
		virtual int init();
		virtual int run();
		int initDetectCfgInfo(int DetectThreshold);
		virtual int uninit();

		virtual ~IT_12_ModleShow_11();
		void initRegion();

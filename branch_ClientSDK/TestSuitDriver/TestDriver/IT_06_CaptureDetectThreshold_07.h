/********************************************************************
* Name      :  IT_06_CaptureDetectThreshold_07.h                                  
* Param     :                                                        
* Return    :                                                        
* Describ   :                                                        
* Author    :  liuixn                                         
...
#ifndef IT_06_CaptureDetectThreshold_07_H
#define IT_06_CaptureDetectThreshold_07_H
...
class IT_06_CaptureDetectThreshold_07:public Driver
{
	public: 
		
		IT_06_CaptureDetectThreshold_07( unsigned int nCaseId );
		virtual int init();
		virtual int run();
		int initDetectCfgInfo(int DetectThreshold);
		virtual int uninit();

		virtual ~IT_06_CaptureDetectThreshold_07();
		void initRegion();

...
#ifndef IT_10_faceCompress_09_H
#define IT_10_faceCompress_09_H
...
class IT_10_faceCompress_09:public Driver
{
	public: 
		
		IT_10_faceCompress_09( unsigned int nCaseId );
		virtual int init();
		virtual int run();
		int initDetectCfgInfo(int DetectThreshold);
		virtual int uninit();

		virtual ~IT_10_faceCompress_09();
		void initRegion();

...
#ifndef IT_11_faceSizeCtrl_07_H
#define IT_11_faceSizeCtrl_07_H
...
class IT_11_faceSizeCtrl_07:public Driver
{
	public: 
		
		IT_11_faceSizeCtrl_07( unsigned int nCaseId );
		virtual int init();
		virtual int run();
		int initDetectCfgInfo(int DetectThreshold);
		virtual int uninit();

		virtual ~IT_11_faceSizeCtrl_07();
		void initRegion();

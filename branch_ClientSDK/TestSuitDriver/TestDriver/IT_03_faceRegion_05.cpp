...
int IT_03_faceRegion_05::init_initDetectFaceIF()
{
...
int IT_03_faceRegion_05:: init_pCallBackInfo()
{
...
IT_03_faceRegion_05::IT_03_faceRegion_05(unsigned int nCaseId ): Driver( nCaseId )
{

}

int IT_03_faceRegion_05::init()
{
...
void testCallbackSetLine5( RWNotifyType *pNotifyType, UINT8 *pExtData, UINT32 *pDataLen )
{
...
void IT_03_faceRegion_05::setline()
{
	CallbackNotifyFunc pFunc = testCallbackSetLine5;
	Line line3;
	line3.Head.X = 0;
	line3.Head.Y = 20;
	line3.End.X = 1000;
...
void IT_03_faceRegion_05::mySetDetectCfg()
{
	int ret32 = 0;
	DetectCfg cfgData;
...
void IT_03_faceRegion_05::addRegion()
{
	int nCount ; 
	nCount = 4; 
	Point tempPoint1[4];
...
void IT_03_faceRegion_05::writeInt32(char* data, int value)
{
...
void  IT_03_faceRegion_05::myAddFrame()
{
	int ret32 = 0;
	int width = 1920;
	int heigth = 1080;
...
int IT_03_faceRegion_05::uninit()
{
	Driver::uninit();
}

IT_03_faceRegion_05::~IT_03_faceRegion_05()
{
...
void IT_03_faceRegion_05::usrCallbackReplyCancalClient2(UINT64 *pReqID,
											  UINT8 *pRet,
											  UINT8 *pReplyData,
											  UINT32 *pDataLen )
{
...
void IT_03_faceRegion_05::usrCallbackReplyRegisterClient2(UINT64 *pReqID,
												UINT8 *pRet,
												UINT8 *pReplyData,
												UINT32 *pDataLen )
{
...
void IT_03_faceRegion_05::usrCallbackNotifyServiceInfo2( RWNotifyType *pNotifyType,
											   UINT8 *pExtData,
											   UINT32 *pDataLen)
{
...
void IT_03_faceRegion_05::usrCallbackNotifyFaceInfo2( RWNotifyType *pNotifyType,
											UINT8 *pExtData,
											UINT32 *pDataLen )
{

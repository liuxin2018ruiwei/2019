...
#ifndef IT_08_FaceRectDraw_01_H
#define IT_08_FaceRectDraw_01_H
...
class IT_08_FaceRectDraw_01:public Driver
{
	public: 
		
		IT_08_FaceRectDraw_01( unsigned int nCaseId );
		virtual int init();
		virtual int run();
		int initDetectCfgInfo(int DetectThreshold);
		virtual int uninit();

		virtual ~IT_08_FaceRectDraw_01();
		void initRegion();

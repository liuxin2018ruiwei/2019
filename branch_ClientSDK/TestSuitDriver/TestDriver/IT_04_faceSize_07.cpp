...
int IT_04_faceSize_07::init_initDetectFaceIF()
{
...
int IT_04_faceSize_07:: init_pCallBackInfo()
{
...
IT_04_faceSize_07::IT_04_faceSize_07(unsigned int nCaseId ): Driver( nCaseId )
{

}

int IT_04_faceSize_07::init()
{
...
/*
void IT_04_faceSize_07::testCallbackSetLineF( RWNotifyType *pNotifyType, UINT8 *pExtData, UINT32 *pDataLen )
{
...
void IT_04_faceSize_07::setline()
{
...
void IT_04_faceSize_07::mySetDetectCfg()
{
	int ret32 = 0;
	DetectCfg cfgData;
...
void IT_04_faceSize_07::addRegion()
{
	int nCount ; 
	nCount = 4; 
	Point tempPoint1[4];
...
void IT_04_faceSize_07::writeInt32(char* data, int value)
{
...
void  IT_04_faceSize_07::myAddFrame()
{
	int ret32 = 0;
	int width = 1920;
	int heigth = 1080;
...
void IT_04_faceSize_07::initHeatBeat()
{
	int ret32 = 0;
	DetectCfg cfgData;
...
void IT_04_faceSize_07::initDetectFace()
{
	int ret32 = 0;
	DetectCfg cfgData;
...
int IT_04_faceSize_07::faceSize(UINT16 faceSizeValue)
{
	int ret32 = 0;
	DetectCfg cfgData;
...
int IT_04_faceSize_07::uninit()
{
	Driver::uninit();
}

IT_04_faceSize_07::~IT_04_faceSize_07()
{
...
void IT_04_faceSize_07::usrCallbackReplyCancalClient2(UINT64 *pReqID,
											  UINT8 *pRet,
											  UINT8 *pReplyData,
											  UINT32 *pDataLen )
{
...
void IT_04_faceSize_07::usrCallbackReplyRegisterClient2(UINT64 *pReqID,
												UINT8 *pRet,
												UINT8 *pReplyData,
												UINT32 *pDataLen )
{
...
void IT_04_faceSize_07::usrCallbackNotifyServiceInfo2( RWNotifyType *pNotifyType,
											   UINT8 *pExtData,
											   UINT32 *pDataLen)
{
...
void IT_04_faceSize_07::usrCallbackNotifyFaceInfo2( RWNotifyType *pNotifyType,
											UINT8 *pExtData,
											UINT32 *pDataLen )
{

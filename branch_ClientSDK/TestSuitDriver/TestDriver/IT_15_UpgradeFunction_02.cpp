/********************************************************************
* Name      :  IT_15_UpgradeFunction_02.cpp                                  
* Param     :                                                        
* Return    :                                                        
* Describ   :                                                        
* Author    :  Liu Xin                                          
...
int IT_15_UpgradeFunction_02::init_initDetectFaceIF()
{
...
int IT_15_UpgradeFunction_02:: init_pCallBackInfo()
{
...
IT_15_UpgradeFunction_02::IT_15_UpgradeFunction_02(unsigned int nCaseId ): Driver( nCaseId )
{

}

int IT_15_UpgradeFunction_02::init()
{
...
void IT_15_UpgradeFunction_02_CallBackUpgrade(UINT64 *pReqID, UINT8 *pRet, UINT8 *pReplyData,UINT32 *pDataLen )
{
	UINT8 getReplyData  =*pReplyData;
	int data = getReplyData;
	printf("4getReplyData = %d, %X\n",data, getReplyData);
	if(0  == getReplyData)
	{
...
int IT_15_UpgradeFunction_02::upgradeAppCfg()
{
	int ret32 = 0;
	...
	CallbackReplyFunc pFuncTest = IT_15_UpgradeFunction_02_CallBackUpgrade; 
	printf("\n%x\n",pFuncTest);
...
int IT_15_UpgradeFunction_02::upgradeAppPkg()
{
	int ret32 = 0;
...
int IT_15_UpgradeFunction_02::upgradeCamereaQSPI()
{
	int ret32 = 0;
	...
	UINT8 tempMD5[16] ={    	0xc9,0xd1,0xcd,0x92,
								0x2e,0x6f,0x53,0x16,
								0x2f,0xb9,0xfc,0x12,
								0xbc,0xb6,0x77,0x13 }; 
...
int IT_15_UpgradeFunction_02::getpDataCfgInfo( )
{
...
void IT_15_UpgradeFunction_02::qurySoftVersion()
{
...
void IT_15_UpgradeFunction_02::initHeatBeat()
{
	int ret32 = 0;
	DetectCfg cfgData;
...
int IT_15_UpgradeFunction_02::run()
{
	initHeatBeat();
...
int IT_15_UpgradeFunction_02::uninit()
{
	Driver::uninit();
}

IT_15_UpgradeFunction_02::~IT_15_UpgradeFunction_02()
{
...
void IT_15_UpgradeFunction_02::usrCallbackReplyCancalClient1(UINT64 *pReqID,
											  UINT8 *pRet,
											  UINT8 *pReplyData,
											  UINT32 *pDataLen )
{
...
void IT_15_UpgradeFunction_02::usrCallbackReplyRegisterClient1(UINT64 *pReqID,
												UINT8 *pRet,
												UINT8 *pReplyData,
												UINT32 *pDataLen )
{
...
void IT_15_UpgradeFunction_02::usrCallbackNotifyServiceInfo1( RWNotifyType *pNotifyType,
											   UINT8 *pExtData,
											   UINT32 *pDataLen)
{
	//printf("---the notify CLIENT INFO type=%d, datalen=%d", *pNotifyType, *pDataLen );
}
void IT_15_UpgradeFunction_02::usrCallbackNotifyFaceInfo1( RWNotifyType *pNotifyType,
											UINT8 *pExtData,
											UINT32 *pDataLen )
{

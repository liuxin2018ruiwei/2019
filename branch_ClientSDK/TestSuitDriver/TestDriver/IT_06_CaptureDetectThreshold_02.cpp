/********************************************************************
* Name      :  IT_06_CaptureDetectThreshold_02.cpp                                  
* Param     :                                                        
* Return    :                                                        
* Describ   :                                                        
* Author    :  Liu Xin                                          
...
int IT_06_CaptureDetectThreshold_02::init_initDetectFaceIF()
{
...
int IT_06_CaptureDetectThreshold_02:: init_pCallBackInfo()
{
...
IT_06_CaptureDetectThreshold_02::IT_06_CaptureDetectThreshold_02(unsigned int nCaseId ): Driver( nCaseId )
{

}

int IT_06_CaptureDetectThreshold_02::init()
{
...
/*
void IT_06_CaptureDetectThreshold_02::testCallbackSetLineF( RWNotifyType *pNotifyType, UINT8 *pExtData, UINT32 *pDataLen )
{
...
void IT_06_CaptureDetectThreshold_02::setline()
{
...
void IT_06_CaptureDetectThreshold_02::mySetDetectCfg()
{
	int ret32 = 0;
	DetectCfg cfgData;
...
void IT_06_CaptureDetectThreshold_02::addRegion()
{
	int nCount ; 
	nCount = 4; 
	Point tempPoint1[4];
...
void IT_06_CaptureDetectThreshold_02::writeInt32(char* data, int value)
{
...
void  IT_06_CaptureDetectThreshold_02::myAddFrame()
{
	int ret32 = 0;
	int width = 1920;
	int heigth = 1080;
...
void IT_06_CaptureDetectThreshold_02::initHeatBeat()
{
	int ret32 = 0;
	DetectCfg cfgData;
...
void IT_06_CaptureDetectThreshold_02::initDetectFace()
{
	int ret32 = 0;
	DetectCfg cfgData;
...
int IT_06_CaptureDetectThreshold_02::faceSize(UINT16 faceSizeValue)
{
	int ret32 = 0;
	DetectCfg cfgData;
...
int IT_06_CaptureDetectThreshold_02:: faceDetectCapture(int type)
{
	int ret32 = 0;
	DetectCfg cfgData;
	cfgData.ConfigMask = 0x01;
...
int IT_06_CaptureDetectThreshold_02::faceDetectThreshold(int value)
{
	int ret32 = 0;
	DetectCfg cfgData;
...
int IT_06_CaptureDetectThreshold_02::run()
{	
	int ret32 = 0;
	int width = 1920;
	int heigth = 1080;
...
int IT_06_CaptureDetectThreshold_02::uninit()
{
	Driver::uninit();
}

IT_06_CaptureDetectThreshold_02::~IT_06_CaptureDetectThreshold_02()
{
...
void IT_06_CaptureDetectThreshold_02::usrCallbackReplyCancalClient2(UINT64 *pReqID,
											  UINT8 *pRet,
											  UINT8 *pReplyData,
											  UINT32 *pDataLen )
{
...
void IT_06_CaptureDetectThreshold_02::usrCallbackReplyRegisterClient2(UINT64 *pReqID,
												UINT8 *pRet,
												UINT8 *pReplyData,
												UINT32 *pDataLen )
{
...
void IT_06_CaptureDetectThreshold_02::usrCallbackNotifyServiceInfo2( RWNotifyType *pNotifyType,
											   UINT8 *pExtData,
											   UINT32 *pDataLen)
{
...
void IT_06_CaptureDetectThreshold_02::usrCallbackNotifyFaceInfo2( RWNotifyType *pNotifyType,
											UINT8 *pExtData,
											UINT32 *pDataLen )
{

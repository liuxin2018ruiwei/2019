...
#ifndef IT_14_CountPeople_10_H
#define IT_14_CountPeople_10_H
...
class IT_14_CountPeople_10:public Driver
{
	public: 
		
		IT_14_CountPeople_10( unsigned int nCaseId );
		virtual int init();
		virtual int run();
		int initDetectCfgInfo(int DetectThreshold);
		virtual int uninit();

		virtual ~IT_14_CountPeople_10();
		void initRegion();

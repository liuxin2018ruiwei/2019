...
#ifndef IT_10_faceCompress_07_H
#define IT_10_faceCompress_07_H
...
class IT_10_faceCompress_07:public Driver
{
	public: 
		
		IT_10_faceCompress_07( unsigned int nCaseId );
		virtual int init();
		virtual int run();
		int initDetectCfgInfo(int DetectThreshold);
		virtual int uninit();

		virtual ~IT_10_faceCompress_07();
		void initRegion();

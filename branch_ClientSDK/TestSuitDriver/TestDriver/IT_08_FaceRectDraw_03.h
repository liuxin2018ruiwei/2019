...
#ifndef IT_08_FaceRectDraw_03_H
#define IT_08_FaceRectDraw_03_H
...
class IT_08_FaceRectDraw_03:public Driver
{
	public: 
		
		IT_08_FaceRectDraw_03( unsigned int nCaseId );
		virtual int init();
		virtual int run();
		int initDetectCfgInfo(int DetectThreshold);
		virtual int uninit();

		virtual ~IT_08_FaceRectDraw_03();
		void initRegion();

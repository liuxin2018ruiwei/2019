...
#ifndef ST_18_setLine_H
#define ST_18_setLine_H

#include "Driver.h"


class ST_18_setLine:public Driver
{
	public: 
		
		ST_18_setLine( unsigned int nCaseId );
		virtual int init();
		virtual int run();
		int initDetectCfgInfo(int DetectThreshold);
		virtual int uninit();

		virtual ~ST_18_setLine();
		void initRegion();

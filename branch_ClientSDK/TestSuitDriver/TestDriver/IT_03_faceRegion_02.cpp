...
int IT_03_faceRegion_02::init_initDetectFaceIF()
{
...
int IT_03_faceRegion_02:: init_pCallBackInfo()
{
...
IT_03_faceRegion_02::IT_03_faceRegion_02(unsigned int nCaseId ): Driver( nCaseId )
{

}

int IT_03_faceRegion_02::init()
{
...
void testCallbackSetLine2( RWNotifyType *pNotifyType, UINT8 *pExtData, UINT32 *pDataLen )
{
...
void IT_03_faceRegion_02::setline()
{
	CallbackNotifyFunc pFunc = testCallbackSetLine2;
	Line line3;
	line3.Head.X = 0;
	line3.Head.Y = 20;
	line3.End.X = 1000;
...
void IT_03_faceRegion_02::mySetDetectCfg()
{
	int ret32 = 0;
	DetectCfg cfgData;
...
void IT_03_faceRegion_02::addRegion()
{
	int nCount ; 
	nCount = 4; 
	Point tempPoint1[4];
...
void IT_03_faceRegion_02::writeInt32(char* data, int value)
{
...
void  IT_03_faceRegion_02::myAddFrame()
{
	int ret32 = 0;
	int width = 1920;
	int heigth = 1080;
...
{	
	...
	tempPoint2[3].X = 1300;	
	tempPoint2[3].Y = 1001;	
	addShieldRegion( m_TFHandle, (Point *)(&tempPoint2),  nCount );
...
int IT_03_faceRegion_02::uninit()
{
	Driver::uninit();
}

IT_03_faceRegion_02::~IT_03_faceRegion_02()
{
...
void IT_03_faceRegion_02::usrCallbackReplyCancalClient2(UINT64 *pReqID,
											  UINT8 *pRet,
											  UINT8 *pReplyData,
											  UINT32 *pDataLen )
{
...
void IT_03_faceRegion_02::usrCallbackReplyRegisterClient2(UINT64 *pReqID,
												UINT8 *pRet,
												UINT8 *pReplyData,
												UINT32 *pDataLen )
{
...
void IT_03_faceRegion_02::usrCallbackNotifyServiceInfo2( RWNotifyType *pNotifyType,
											   UINT8 *pExtData,
											   UINT32 *pDataLen)
{
...
void IT_03_faceRegion_02::usrCallbackNotifyFaceInfo2( RWNotifyType *pNotifyType,
											UINT8 *pExtData,
											UINT32 *pDataLen )
{

...
#ifndef IT_08_FaceRectDraw_10_H
#define IT_08_FaceRectDraw_10_H
...
class IT_08_FaceRectDraw_10:public Driver
{
	public: 
		
		IT_08_FaceRectDraw_10( unsigned int nCaseId );
		virtual int init();
		virtual int run();
		int initDetectCfgInfo(int DetectThreshold);
		virtual int uninit();

		virtual ~IT_08_FaceRectDraw_10();
		void initRegion();

/********************************************************************
* Name      :  ST_8_uninitDetectFaceIF.h                                  
* Param     :                                                        
* Return    :                                                        
* Describ   :                                                        
* Author    :  liuixn                                         
...
#ifndef ST_8_uninitDetectFaceIF_H
#define ST_8_uninitDetectFaceIF_H

#include "Driver.h"


class ST_8_uninitDetectFaceIF:public Driver
{
	public: 
		
		ST_8_uninitDetectFaceIF( unsigned int nCaseId );
		virtual int init();
		virtual int run();
		int initDetectCfgInfo(int DetectThreshold);
		virtual int uninit();

		virtual ~ST_8_uninitDetectFaceIF();
		void initRegion();

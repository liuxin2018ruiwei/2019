...
int IT_12_ModleShow_08::init_initDetectFaceIF()
{
...
int IT_12_ModleShow_08:: init_pCallBackInfo()
{
...
IT_12_ModleShow_08::IT_12_ModleShow_08(unsigned int nCaseId ): Driver( nCaseId )
{

}

int IT_12_ModleShow_08::init()
{
...
/*
void IT_12_ModleShow_08::testCallbackSetLineF( RWNotifyType *pNotifyType, UINT8 *pExtData, UINT32 *pDataLen )
{
...
void IT_12_ModleShow_08::setline()
{
...
void IT_12_ModleShow_08::mySetDetectCfg()
{
	int ret32 = 0;
	DetectCfg cfgData;
...
void IT_12_ModleShow_08::addRegion()
{
	int nCount ; 
	nCount = 4; 
	Point tempPoint1[4];
...
void IT_12_ModleShow_08::writeInt32(char* data, int value)
{
...
void  IT_12_ModleShow_08::myAddFrame()
{
	int ret32 = 0;
	int width = 1920;
	int heigth = 1080;
...
void IT_12_ModleShow_08::initHeatBeat()
{
	int ret32 = 0;
	DetectCfg cfgData;
...
void IT_12_ModleShow_08::initDetectFace()
{
	int ret32 = 0;
	DetectCfg cfgData;
...
int IT_12_ModleShow_08::faceSize(UINT16 faceSizeValue)
{
	int ret32 = 0;
	DetectCfg cfgData;
...
int IT_12_ModleShow_08:: faceDetectCapture(int type)
{
	int ret32 = 0;
	DetectCfg cfgData;
	cfgData.ConfigMask = 0x01;
...
void IT_12_ModleShow_08::backGroundPicSwith(UINT8 data)
{
	int ret32 = 0;
	DetectCfg cfgData;
...
int IT_12_ModleShow_08::faceDetectThreshold(int value)
{
	int ret32 = 0;
	DetectCfg cfgData;
...
int IT_12_ModleShow_08::setFaceCtrl(UINT8 faceData)
{
	int ret32 = 0;
	DetectCfg cfgData;
...
void IT_12_ModleShow_08::qurySoftVersion()
{
...
int IT_12_ModleShow_08::uninit()
{
	Driver::uninit();
}

IT_12_ModleShow_08::~IT_12_ModleShow_08()
{
...
void IT_12_ModleShow_08::usrCallbackReplyCancalClient2(UINT64 *pReqID,
											  UINT8 *pRet,
											  UINT8 *pReplyData,
											  UINT32 *pDataLen )
{
...
void IT_12_ModleShow_08::usrCallbackReplyRegisterClient2(UINT64 *pReqID,
												UINT8 *pRet,
												UINT8 *pReplyData,
												UINT32 *pDataLen )
{
...
void IT_12_ModleShow_08::usrCallbackNotifyServiceInfo2( RWNotifyType *pNotifyType,
											   UINT8 *pExtData,
											   UINT32 *pDataLen)
{
...
static int  IT_12_ModleShow_08_m_flag1;

void IT_12_ModleShow_08::usrCallbackNotifyFaceInfo2( RWNotifyType *pNotifyType,
											UINT8 *pExtData,
											UINT32 *pDataLen )
{
	...
	else if (NotifyImgData == getRWNotifyType)
	{
		...
		char picName[40]  = {0};
		snprintf(picName, 40, "/dev/lxPic_%d.jpg", IT_12_ModleShow_08_m_flag1++);

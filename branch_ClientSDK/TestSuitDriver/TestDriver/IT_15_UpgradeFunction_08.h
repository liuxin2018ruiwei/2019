/********************************************************************
* Name      :  IT_15_UpgradeFunction_08.h                                  
* Param     :                                                        
* Return    :                                                        
* Describ   :                                                        
* Author    :  liuixn                                         
...
#ifndef IT_15_UpgradeFunction_08_H
#define IT_15_UpgradeFunction_08_H

#include "Driver.h"


class IT_15_UpgradeFunction_08:public Driver
{
	public: 
		
		IT_15_UpgradeFunction_08( unsigned int nCaseId );
		virtual int init();
		virtual int run();
		int initDetectCfgInfo(int DetectThreshold);
		virtual int uninit();

		virtual ~IT_15_UpgradeFunction_08();
		void initRegion();

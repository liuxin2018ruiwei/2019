...
int IT_14_CountPeople_10::init_initDetectFaceIF()
{
...
int IT_14_CountPeople_10:: init_pCallBackInfo()
{
...
IT_14_CountPeople_10::IT_14_CountPeople_10(unsigned int nCaseId ): Driver( nCaseId )
{

}

int IT_14_CountPeople_10::init()
{
...
void testCallbackSetLine_IT_14_CountPeople_10( RWNotifyType *pNotifyType, UINT8 *pExtData, UINT32 *pDataLen )
{
...
void IT_14_CountPeople_10::setline()
{
	CallbackNotifyFunc pFunc = testCallbackSetLine_IT_14_CountPeople_10;
	Line line3;
	line3.Head.X = 0;
	line3.Head.Y = 440;
	line3.End.X = 1920;
...
void IT_14_CountPeople_10::mySetDetectCfg()
{
	int ret32 = 0;
	DetectCfg cfgData;
...
void IT_14_CountPeople_10::addRegion()
{
	int nCount ; 
	nCount = 4; 
	Point tempPoint1[4];
...
void IT_14_CountPeople_10::writeInt32(char* data, int value)
{
...
void  IT_14_CountPeople_10::myAddFrame()
{
	int ret32 = 0;
	int width = 1920;
	int heigth = 1080;
...
void IT_14_CountPeople_10::initHeatBeat()
{
	int ret32 = 0;
	DetectCfg cfgData;
...
void IT_14_CountPeople_10::initDetectFace()
{
	int ret32 = 0;
	DetectCfg cfgData;
...
int IT_14_CountPeople_10::faceSize(UINT16 faceSizeValue)
{
	int ret32 = 0;
	DetectCfg cfgData;
...
int IT_14_CountPeople_10:: faceDetectCapture(int type)
{
	int ret32 = 0;
	DetectCfg cfgData;
	cfgData.ConfigMask = 0x01;
...
void IT_14_CountPeople_10::backGroundPicSwith(UINT8 data)
{
	int ret32 = 0;
	DetectCfg cfgData;
...
int IT_14_CountPeople_10::faceDetectThreshold(int value)
{
	int ret32 = 0;
	DetectCfg cfgData;
...
int IT_14_CountPeople_10::setFaceCtrl(UINT8 faceData)
{
	int ret32 = 0;
	DetectCfg cfgData;
...
void IT_14_CountPeople_10::qurySoftVersion()
{
...
int IT_14_CountPeople_10::uninit()
{
	Driver::uninit();
}

IT_14_CountPeople_10::~IT_14_CountPeople_10()
{
...
void IT_14_CountPeople_10::usrCallbackReplyCancalClient2(UINT64 *pReqID,
											  UINT8 *pRet,
											  UINT8 *pReplyData,
											  UINT32 *pDataLen )
{
...
void IT_14_CountPeople_10::usrCallbackReplyRegisterClient2(UINT64 *pReqID,
												UINT8 *pRet,
												UINT8 *pReplyData,
												UINT32 *pDataLen )
{
...
void IT_14_CountPeople_10::usrCallbackNotifyServiceInfo2( RWNotifyType *pNotifyType,
											   UINT8 *pExtData,
											   UINT32 *pDataLen)
{
...
static int  IT_14_CountPeople_10_m_flag1;
static int flag = 0;

void IT_14_CountPeople_10::usrCallbackNotifyFaceInfo2( RWNotifyType *pNotifyType,
											UINT8 *pExtData,
											UINT32 *pDataLen )
{
	...
	else if (NotifyImgData == getRWNotifyType)
	{
		...
		char picName[40]  = {0};
		snprintf(picName, 40, "/dev/lxPic_%d.jpg", IT_14_CountPeople_10_m_flag1++);

...
#ifndef IT_10_faceCompress_06_H
#define IT_10_faceCompress_06_H
...
class IT_10_faceCompress_06:public Driver
{
	public: 
		
		IT_10_faceCompress_06( unsigned int nCaseId );
		virtual int init();
		virtual int run();
		int initDetectCfgInfo(int DetectThreshold);
		virtual int uninit();

		virtual ~IT_10_faceCompress_06();
		void initRegion();

/********************************************************************
* Name      :  IT_06_CaptureDetectThreshold_08.cpp                                  
* Param     :                                                        
* Return    :                                                        
* Describ   :                                                        
* Author    :  Liu Xin                                          
...
int IT_06_CaptureDetectThreshold_08::init_initDetectFaceIF()
{
...
int IT_06_CaptureDetectThreshold_08:: init_pCallBackInfo()
{
...
IT_06_CaptureDetectThreshold_08::IT_06_CaptureDetectThreshold_08(unsigned int nCaseId ): Driver( nCaseId )
{

}

int IT_06_CaptureDetectThreshold_08::init()
{
...
/*
void IT_06_CaptureDetectThreshold_08::testCallbackSetLineF( RWNotifyType *pNotifyType, UINT8 *pExtData, UINT32 *pDataLen )
{
...
void IT_06_CaptureDetectThreshold_08::setline()
{
...
void IT_06_CaptureDetectThreshold_08::mySetDetectCfg()
{
	int ret32 = 0;
	DetectCfg cfgData;
...
void IT_06_CaptureDetectThreshold_08::addRegion()
{
	int nCount ; 
	nCount = 4; 
	Point tempPoint1[4];
...
void IT_06_CaptureDetectThreshold_08::writeInt32(char* data, int value)
{
...
void  IT_06_CaptureDetectThreshold_08::myAddFrame()
{
	int ret32 = 0;
	int width = 1920;
	int heigth = 1080;
...
void IT_06_CaptureDetectThreshold_08::initHeatBeat()
{
	int ret32 = 0;
	DetectCfg cfgData;
...
void IT_06_CaptureDetectThreshold_08::initDetectFace()
{
	int ret32 = 0;
	DetectCfg cfgData;
...
int IT_06_CaptureDetectThreshold_08::faceSize(UINT16 faceSizeValue)
{
	int ret32 = 0;
	DetectCfg cfgData;
...
int IT_06_CaptureDetectThreshold_08:: faceDetectCapture(int type)
{
	int ret32 = 0;
	DetectCfg cfgData;
	cfgData.ConfigMask = 0x01;
...
int IT_06_CaptureDetectThreshold_08::faceDetectThreshold(int value)
{
	int ret32 = 0;
	DetectCfg cfgData;
...
int IT_06_CaptureDetectThreshold_08::run()
{	
	int ret32 = 0;
	int width = 1920;
	int heigth = 1080;
...
int IT_06_CaptureDetectThreshold_08::uninit()
{
	Driver::uninit();
}

IT_06_CaptureDetectThreshold_08::~IT_06_CaptureDetectThreshold_08()
{
...
void IT_06_CaptureDetectThreshold_08::usrCallbackReplyCancalClient2(UINT64 *pReqID,
											  UINT8 *pRet,
											  UINT8 *pReplyData,
											  UINT32 *pDataLen )
{
...
void IT_06_CaptureDetectThreshold_08::usrCallbackReplyRegisterClient2(UINT64 *pReqID,
												UINT8 *pRet,
												UINT8 *pReplyData,
												UINT32 *pDataLen )
{
...
void IT_06_CaptureDetectThreshold_08::usrCallbackNotifyServiceInfo2( RWNotifyType *pNotifyType,
											   UINT8 *pExtData,
											   UINT32 *pDataLen)
{
...
void IT_06_CaptureDetectThreshold_08::usrCallbackNotifyFaceInfo2( RWNotifyType *pNotifyType,
											UINT8 *pExtData,
											UINT32 *pDataLen )
{

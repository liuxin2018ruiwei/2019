...
#ifndef IT_08_FaceRectDraw_07_H
#define IT_08_FaceRectDraw_07_H
...
class IT_08_FaceRectDraw_07:public Driver
{
	public: 
		
		IT_08_FaceRectDraw_07( unsigned int nCaseId );
		virtual int init();
		virtual int run();
		int initDetectCfgInfo(int DetectThreshold);
		virtual int uninit();

		virtual ~IT_08_FaceRectDraw_07();
		void initRegion();

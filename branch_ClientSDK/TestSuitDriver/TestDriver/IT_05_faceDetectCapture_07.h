/********************************************************************
* Name      :  IT_05_faceDetectCapture_07.h                                  
* Param     :                                                        
* Return    :                                                        
* Describ   :                                                        
* Author    :  liuixn                                         
...
#ifndef IT_05_faceDetectCapture_07_H
#define IT_05_faceDetectCapture_07_H
...
class IT_05_faceDetectCapture_07:public Driver
{
	public: 
		
		IT_05_faceDetectCapture_07( unsigned int nCaseId );
		virtual int init();
		virtual int run();
		int initDetectCfgInfo(int DetectThreshold);
		virtual int uninit();

		virtual ~IT_05_faceDetectCapture_07();
		void initRegion();

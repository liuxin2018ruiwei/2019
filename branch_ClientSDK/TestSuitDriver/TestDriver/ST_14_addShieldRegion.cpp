/********************************************************************
* Name      :  ST_14_addShieldRegion.cpp                                  
* Param     :                                                        
* Return    :                                                        
* Describ   :                                                        
* Author    :  Liu Xin                                          
...
int ST_14_addShieldRegion::init_initDetectFaceIF()
{
...
int ST_14_addShieldRegion:: init_pCallBackInfo()
{
...
ST_14_addShieldRegion::ST_14_addShieldRegion(unsigned int nCaseId ): Driver( nCaseId )
{

}

int ST_14_addShieldRegion::init()
{
...
int ST_14_addShieldRegion::run()
{
	...
	printf("ST_14_addShieldRegion_1 \n");
	ret32 = addShieldRegion( NULL, NULL, 0 );
	if(ret32 < 0)
	{
		printf("ST_14_addShieldRegion_1  ok\n\n");
	}else{
		printf("ST_14_addShieldRegion_1  ERR\n\n");
	}

	printf("ST_14_addShieldRegion_2 \n");
	ret32 = addShieldRegion( NULL, (Point *)(&tempPoint4), 0 );
	if(ret32 < 0)
	{
		printf("ST_14_addShieldRegion_2  ok\n\n");
	}else{
		printf("ST_14_addShieldRegion_2  ERR\n\n");
	}

	printf("ST_14_addShieldRegion_3 \n");
	ret32 = addShieldRegion( m_TFHandle, (Point *)(&tempPoint4), 0 );
	if(ret32 < 0)
	{
		printf("ST_14_addShieldRegion_3  ok\n\n");
	}else{
		printf("ST_14_addShieldRegion_3  ERR\n\n");
	}


	printf("ST_14_addShieldRegion_4 \n");
	ret32 = addShieldRegion( m_TFHandle, (Point *)(&tempPoint4), nCount );
	if(ret32 == 0)
	{
		printf("ST_14_addShieldRegion_4  ok\n\n");
	}else{
		printf("ST_14_addShieldRegion_4  ERR\n\n");
	}
	deletetShieldRegion(m_TFHandle, (Point *)(&tempPoint4), nCount );
	

	printf("ST_14_addShieldRegion_5 \n");
	nCount = 8;	
	Point tempPoint8[8];
	tempPoint8[0].X = 50;	
	tempPoint8[0].Y = 20;	
	...
	if(ret32 == 0)
	{
		printf("ST_14_addShieldRegion_5  ok\n\n");
	}
	else
	{
		printf("ST_14_addShieldRegion_5  ERR\n\n");
	}
	deletetShieldRegion(m_TFHandle, (Point *)(&tempPoint8), nCount );


	printf("ST_14_addShieldRegion_6 \n");
	nCount = 10 ; 
	...
	if(ret32 < 0)
	{
		printf("ST_14_addShieldRegion_6  ok\n\n");
	}
	else
	{
		printf("ST_14_addShieldRegion_6  ERR\n\n");
	}

	printf("ST_14_addShieldRegion_7 \n");
	nCount = 3;
	Point tempPoint3[3];
	tempPoint3[0].X = 20;	
	tempPoint3[0].Y = 20;	
	...
	if(0 == ret32 )
	{
		printf("ST_14_addShieldRegion_7 ok\n\n");
	}
	else
	{
		printf("ST_14_addShieldRegion_7  ERR\n\n");
	}

	printf("ST_14_addShieldRegion_8 \n");
	nCount = 3;
	//Point tempPoint3[3];
	tempPoint3[0].X = 2020;	
	tempPoint3[0].Y = 20;	
	...
	if(ret32 < 0  )
	{
		printf("ST_14_addShieldRegion_8 ok\n\n");
	}
	else
	{
		printf("ST_14_addShieldRegion_8 ERR\n\n");
	}

	


	printf("-------test addShieldRegion ok -----\n");

	return 0;
}


int ST_14_addShieldRegion::uninit()
{
	Driver::uninit();
}

ST_14_addShieldRegion::~ST_14_addShieldRegion()
{
...
void ST_14_addShieldRegion::usrCallbackReplyCancalClient1(UINT64 *pReqID,
											  UINT8 *pRet,
											  UINT8 *pReplyData,
											  UINT32 *pDataLen )
{
...
void ST_14_addShieldRegion::usrCallbackReplyRegisterClient1(UINT64 *pReqID,
												UINT8 *pRet,
												UINT8 *pReplyData,
												UINT32 *pDataLen )
{
...
void ST_14_addShieldRegion::usrCallbackNotifyServiceInfo1( RWNotifyType *pNotifyType,
											   UINT8 *pExtData,
											   UINT32 *pDataLen)
{
	//printf("---the notify CLIENT INFO type=%d, datalen=%d", *pNotifyType, *pDataLen );
}
void ST_14_addShieldRegion::usrCallbackNotifyFaceInfo1( RWNotifyType *pNotifyType,
											UINT8 *pExtData,
											UINT32 *pDataLen )
{

...
#ifndef IT_12_ModleShow_02_H
#define IT_12_ModleShow_02_H
...
class IT_12_ModleShow_02:public Driver
{
	public: 
		
		IT_12_ModleShow_02( unsigned int nCaseId );
		virtual int init();
		virtual int run();
		int initDetectCfgInfo(int DetectThreshold);
		virtual int uninit();

		virtual ~IT_12_ModleShow_02();
		void initRegion();

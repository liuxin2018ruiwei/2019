...
#ifndef IT_11_faceSizeCtrl_11_H
#define IT_11_faceSizeCtrl_11_H
...
class IT_11_faceSizeCtrl_11:public Driver
{
	public: 
		
		IT_11_faceSizeCtrl_11( unsigned int nCaseId );
		virtual int init();
		virtual int run();
		int initDetectCfgInfo(int DetectThreshold);
		virtual int uninit();

		virtual ~IT_11_faceSizeCtrl_11();
		void initRegion();

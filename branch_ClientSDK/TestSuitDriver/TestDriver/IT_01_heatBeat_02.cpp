...
int IT_01_heatBeat_02::init_initDetectFaceIF()
{
...
int IT_01_heatBeat_02:: init_pCallBackInfo()
{
...
IT_01_heatBeat_02::IT_01_heatBeat_02(unsigned int nCaseId ): Driver( nCaseId )
{

}

int IT_01_heatBeat_02::init()
{
...
int IT_01_heatBeat_02::uninit()
{
	Driver::uninit();
}

IT_01_heatBeat_02::~IT_01_heatBeat_02()
{
...
void IT_01_heatBeat_02::usrCallbackReplyCancalClient1(UINT64 *pReqID,
											  UINT8 *pRet,
											  UINT8 *pReplyData,
											  UINT32 *pDataLen )
{
...
void IT_01_heatBeat_02::usrCallbackReplyRegisterClient1(UINT64 *pReqID,
												UINT8 *pRet,
												UINT8 *pReplyData,
												UINT32 *pDataLen )
{
...
void IT_01_heatBeat_02::usrCallbackNotifyServiceInfo1( RWNotifyType *pNotifyType,
											   UINT8 *pExtData,
											   UINT32 *pDataLen)
{
	printf("---the notify CLIENT INFO type=%d, datalen=%d", *pNotifyType, *pDataLen );
}
void IT_01_heatBeat_02::usrCallbackNotifyFaceInfo1( RWNotifyType *pNotifyType,
											UINT8 *pExtData,
											UINT32 *pDataLen )
{

...
#ifndef IT_11_faceSizeCtrl_06_H
#define IT_11_faceSizeCtrl_06_H
...
class IT_11_faceSizeCtrl_06:public Driver
{
	public: 
		
		IT_11_faceSizeCtrl_06( unsigned int nCaseId );
		virtual int init();
		virtual int run();
		int initDetectCfgInfo(int DetectThreshold);
		virtual int uninit();

		virtual ~IT_11_faceSizeCtrl_06();
		void initRegion();

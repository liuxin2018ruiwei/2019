...
#ifndef IT_12_ModleShow_04_H
#define IT_12_ModleShow_04_H
...
class IT_12_ModleShow_04:public Driver
{
	public: 
		
		IT_12_ModleShow_04( unsigned int nCaseId );
		virtual int init();
		virtual int run();
		int initDetectCfgInfo(int DetectThreshold);
		virtual int uninit();

		virtual ~IT_12_ModleShow_04();
		void initRegion();

...
#ifndef IT_14_CountPeople_01_H
#define IT_14_CountPeople_01_H
...
class IT_14_CountPeople_01:public Driver
{
	public: 
		
		IT_14_CountPeople_01( unsigned int nCaseId );
		virtual int init();
		virtual int run();
		int initDetectCfgInfo(int DetectThreshold);
		virtual int uninit();

		virtual ~IT_14_CountPeople_01();
		void initRegion();

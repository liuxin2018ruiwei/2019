...
int IT_03_faceRegion_07::init_initDetectFaceIF()
{
...
int IT_03_faceRegion_07:: init_pCallBackInfo()
{
...
IT_03_faceRegion_07::IT_03_faceRegion_07(unsigned int nCaseId ): Driver( nCaseId )
{

}

int IT_03_faceRegion_07::init()
{
...
void testCallbackSetLine7( RWNotifyType *pNotifyType, UINT8 *pExtData, UINT32 *pDataLen )
{
...
void IT_03_faceRegion_07::setline()
{
	CallbackNotifyFunc pFunc = testCallbackSetLine7;
	Line line3;
	line3.Head.X = 0;
	line3.Head.Y = 20;
	line3.End.X = 1000;
...
void IT_03_faceRegion_07::mySetDetectCfg()
{
	int ret32 = 0;
	DetectCfg cfgData;
...
void IT_03_faceRegion_07::addRegion()
{
	int nCount ; 
	nCount = 4; 
	Point tempPoint1[4];
...
void IT_03_faceRegion_07::writeInt32(char* data, int value)
{
...
void  IT_03_faceRegion_07::myAddFrame()
{
	int ret32 = 0;
	int width = 1920;
	int heigth = 1080;
...
void IT_03_faceRegion_07::initHeatBeat()
{
	int ret32 = 0;
	DetectCfg cfgData;
...
void IT_03_faceRegion_07::initDetectFace()
{
	int ret32 = 0;
	DetectCfg cfgData;
...
int IT_03_faceRegion_07::uninit()
{
	Driver::uninit();
}

IT_03_faceRegion_07::~IT_03_faceRegion_07()
{
...
void IT_03_faceRegion_07::usrCallbackReplyCancalClient2(UINT64 *pReqID,
											  UINT8 *pRet,
											  UINT8 *pReplyData,
											  UINT32 *pDataLen )
{
...
void IT_03_faceRegion_07::usrCallbackReplyRegisterClient2(UINT64 *pReqID,
												UINT8 *pRet,
												UINT8 *pReplyData,
												UINT32 *pDataLen )
{
...
void IT_03_faceRegion_07::usrCallbackNotifyServiceInfo2( RWNotifyType *pNotifyType,
											   UINT8 *pExtData,
											   UINT32 *pDataLen)
{
...
void IT_03_faceRegion_07::usrCallbackNotifyFaceInfo2( RWNotifyType *pNotifyType,
											UINT8 *pExtData,
											UINT32 *pDataLen )
{

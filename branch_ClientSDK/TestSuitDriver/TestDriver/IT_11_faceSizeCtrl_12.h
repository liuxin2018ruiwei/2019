...
#ifndef IT_11_faceSizeCtrl_12_H
#define IT_11_faceSizeCtrl_12_H
...
class IT_11_faceSizeCtrl_12:public Driver
{
	public: 
		
		IT_11_faceSizeCtrl_12( unsigned int nCaseId );
		virtual int init();
		virtual int run();
		int initDetectCfgInfo(int DetectThreshold);
		virtual int uninit();

		virtual ~IT_11_faceSizeCtrl_12();
		void initRegion();

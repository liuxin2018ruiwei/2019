/********************************************************************
* Name      :  IT_15_UpgradeFunction_11.cpp                                  
* Param     :                                                        
* Return    :                                                        
* Describ   :                                                        
* Author    :  Liu Xin                                          
...
int IT_15_UpgradeFunction_11::init_initDetectFaceIF()
{
...
int IT_15_UpgradeFunction_11:: init_pCallBackInfo()
{
...
IT_15_UpgradeFunction_11::IT_15_UpgradeFunction_11(unsigned int nCaseId ): Driver( nCaseId )
{

}

int IT_15_UpgradeFunction_11::init()
{
...
void IT_15_UpgradeFunction_11_CallBackUpgrade(UINT64 *pReqID, UINT8 *pRet, UINT8 *pReplyData,UINT32 *pDataLen )
{
	UpgradeReqType getReplyData  =*((UpgradeReqType *) pReplyData);
	printf("14getReplyData = %d\n",getReplyData);
	if(0  == getReplyData)
	{
...
int IT_15_UpgradeFunction_11::upgradeAppCfg()
{
	int ret32 = 0;
	...
	CallbackReplyFunc pFuncTest = IT_15_UpgradeFunction_11_CallBackUpgrade; 
	printf("\n%x\n",pFuncTest);
...
int IT_15_UpgradeFunction_11::upgradeAppPkg()
{
	int ret32 = 0;
...
int IT_15_UpgradeFunction_11::upgradeCamereaQSPI()
{
	int ret32 = 0;
...
int IT_15_UpgradeFunction_11::getpDataCfgInfo( )
{
...
void IT_15_UpgradeFunction_11::qurySoftVersion()
{
...
void IT_15_UpgradeFunction_11::initHeatBeat()
{
	int ret32 = 0;
	DetectCfg cfgData;
...
void IT_15_UpgradeFunction_11::mySetDetectCfg()
{
	int ret32 = 0;
	DetectCfg cfgData;
...
void testCallbackSetLine_IT_15_UpgradeFunction_11( RWNotifyType *pNotifyType, UINT8 *pExtData, UINT32 *pDataLen )
{
...
void IT_15_UpgradeFunction_11::writeInt32(char* data, int value)
{
...
void IT_15_UpgradeFunction_11::setline()
{
	CallbackNotifyFunc pFunc = testCallbackSetLine_IT_15_UpgradeFunction_11;
	Line line3;
	line3.Head.X = 0;
	line3.Head.Y = 440;
	line3.End.X = 1920;
...
int IT_15_UpgradeFunction_11::faceSize(UINT16 faceSizeValue)
{
	int ret32 = 0;
	DetectCfg cfgData;
...
void IT_15_UpgradeFunction_11::initDetectFace()
{
	int ret32 = 0;
	DetectCfg cfgData;
...
void IT_15_UpgradeFunction_11::addRegion()
{
	int nCount ; 
	nCount = 4; 
	Point tempPoint1[4];
...
int IT_15_UpgradeFunction_11:: faceDetectCapture(int type)
{
	int ret32 = 0;
	DetectCfg cfgData;
	cfgData.ConfigMask = 0x01;
...
int IT_15_UpgradeFunction_11::setFaceCtrl(UINT8 faceData)
{
	int ret32 = 0;
	DetectCfg cfgData;
...
void IT_15_UpgradeFunction_11::backGroundPicSwith(UINT8 data)
{
	int ret32 = 0;
	DetectCfg cfgData;
...
int IT_15_UpgradeFunction_11::faceDetectThreshold(int value)
{
	int ret32 = 0;
	DetectCfg cfgData;
...
void  IT_15_UpgradeFunction_11::myAddFrame()
{
	int ret32 = 0;
	int width = 1920;
	int heigth = 1080;
...
int IT_15_UpgradeFunction_11::run()
{
...
int IT_15_UpgradeFunction_11::uninit()
{
	Driver::uninit();
}

IT_15_UpgradeFunction_11::~IT_15_UpgradeFunction_11()
{
...
void IT_15_UpgradeFunction_11::usrCallbackReplyCancalClient1(UINT64 *pReqID,
											  UINT8 *pRet,
											  UINT8 *pReplyData,
											  UINT32 *pDataLen )
{
...
void IT_15_UpgradeFunction_11::usrCallbackReplyRegisterClient1(UINT64 *pReqID,
												UINT8 *pRet,
												UINT8 *pReplyData,
												UINT32 *pDataLen )
{
...
void IT_15_UpgradeFunction_11::usrCallbackNotifyServiceInfo1( RWNotifyType *pNotifyType,
											   UINT8 *pExtData,
											   UINT32 *pDataLen)
{
	//printf("---the notify CLIENT INFO type=%d, datalen=%d", *pNotifyType, *pDataLen );
}
void IT_15_UpgradeFunction_11::usrCallbackNotifyFaceInfo1( RWNotifyType *pNotifyType,
											UINT8 *pExtData,
											UINT32 *pDataLen )
{

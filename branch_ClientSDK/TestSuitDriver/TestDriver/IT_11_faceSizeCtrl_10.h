...
#ifndef IT_11_faceSizeCtrl_10_H
#define IT_11_faceSizeCtrl_10_H
...
class IT_11_faceSizeCtrl_10:public Driver
{
	public: 
		
		IT_11_faceSizeCtrl_10( unsigned int nCaseId );
		virtual int init();
		virtual int run();
		int initDetectCfgInfo(int DetectThreshold);
		virtual int uninit();

		virtual ~IT_11_faceSizeCtrl_10();
		void initRegion();

...
#ifndef IT_14_CountPeople_03_H
#define IT_14_CountPeople_03_H
...
class IT_14_CountPeople_03:public Driver
{
	public: 
		
		IT_14_CountPeople_03( unsigned int nCaseId );
		virtual int init();
		virtual int run();
		int initDetectCfgInfo(int DetectThreshold);
		virtual int uninit();

		virtual ~IT_14_CountPeople_03();
		void initRegion();

/********************************************************************
* Name      :  IT_05_faceDetectCapture_05.h                                  
* Param     :                                                        
* Return    :                                                        
* Describ   :                                                        
* Author    :  liuixn                                         
...
#ifndef IT_05_faceDetectCapture_05_H
#define IT_05_faceDetectCapture_05_H
...
class IT_05_faceDetectCapture_05:public Driver
{
	public: 
		
		IT_05_faceDetectCapture_05( unsigned int nCaseId );
		virtual int init();
		virtual int run();
		int initDetectCfgInfo(int DetectThreshold);
		virtual int uninit();

		virtual ~IT_05_faceDetectCapture_05();
		void initRegion();

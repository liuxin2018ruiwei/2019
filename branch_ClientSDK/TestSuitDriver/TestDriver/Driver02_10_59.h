...
#ifndef DRIVER02_10_59_H
#define DRIVER02_10_59_H
...
class Driver02_10_59:public Driver
{
public: 
enum
{ 
...
{	
 ...
 Driver02_10_59( unsigned int nCaseId );
  virtual int init();
  virtual int run();
  int initDetectCfgInfo(int DetectThreshold);
  virtual int uninit();
  virtual ~Driver02_10_59();
  void initRegion();
 protected: 
 private:
 void lxTest();

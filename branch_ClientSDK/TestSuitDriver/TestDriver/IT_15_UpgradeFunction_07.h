/********************************************************************
* Name      :  IT_15_UpgradeFunction_07.h                                  
* Param     :                                                        
* Return    :                                                        
* Describ   :                                                        
* Author    :  liuixn                                         
...
#ifndef IT_15_UpgradeFunction_07_H
#define IT_15_UpgradeFunction_07_H

#include "Driver.h"


class IT_15_UpgradeFunction_07:public Driver
{
	public: 
		
		IT_15_UpgradeFunction_07( unsigned int nCaseId );
		virtual int init();
		virtual int run();
		int initDetectCfgInfo(int DetectThreshold);
		virtual int uninit();

		virtual ~IT_15_UpgradeFunction_07();
		void initRegion();

...
#ifndef IT_08_FaceRectDraw_09_H
#define IT_08_FaceRectDraw_09_H
...
class IT_08_FaceRectDraw_09:public Driver
{
	public: 
		
		IT_08_FaceRectDraw_09( unsigned int nCaseId );
		virtual int init();
		virtual int run();
		int initDetectCfgInfo(int DetectThreshold);
		virtual int uninit();

		virtual ~IT_08_FaceRectDraw_09();
		void initRegion();

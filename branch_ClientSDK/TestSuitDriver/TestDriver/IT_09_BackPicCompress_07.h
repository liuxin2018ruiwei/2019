/********************************************************************
* Name      :  IT_09_BackPicCompress_07.h                                  
* Param     :                                                        
* Return    :                                                        
* Describ   :                                                        
* Author    :  liuixn                                         
...
#ifndef IT_09_BackPicCompress_07_H
#define IT_09_BackPicCompress_07_H
...
class IT_09_BackPicCompress_07:public Driver
{
	public: 
		
		IT_09_BackPicCompress_07( unsigned int nCaseId );
		virtual int init();
		virtual int run();
		int initDetectCfgInfo(int DetectThreshold);
		virtual int uninit();

		virtual ~IT_09_BackPicCompress_07();
		void initRegion();

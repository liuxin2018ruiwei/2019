...
#ifndef IT_14_CountPeople_02_H
#define IT_14_CountPeople_02_H
...
class IT_14_CountPeople_02:public Driver
{
	public: 
		
		IT_14_CountPeople_02( unsigned int nCaseId );
		virtual int init();
		virtual int run();
		int initDetectCfgInfo(int DetectThreshold);
		virtual int uninit();

		virtual ~IT_14_CountPeople_02();
		void initRegion();

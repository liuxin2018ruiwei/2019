...
#ifndef IT_14_CountPeople_09_H
#define IT_14_CountPeople_09_H
...
class IT_14_CountPeople_09:public Driver
{
	public: 
		
		IT_14_CountPeople_09( unsigned int nCaseId );
		virtual int init();
		virtual int run();
		int initDetectCfgInfo(int DetectThreshold);
		virtual int uninit();

		virtual ~IT_14_CountPeople_09();
		void initRegion();

/********************************************************************
* Name      :  IT_05_faceDetectCapture_01.cpp                                  
* Param     :                                                        
* Return    :                                                        
* Describ   :                                                        
* Author    :  Liu Xin                                          
...
int IT_05_faceDetectCapture_01::init_initDetectFaceIF()
{
...
int IT_05_faceDetectCapture_01:: init_pCallBackInfo()
{
...
IT_05_faceDetectCapture_01::IT_05_faceDetectCapture_01(unsigned int nCaseId ): Driver( nCaseId )
{

}

int IT_05_faceDetectCapture_01::init()
{
...
/*
void IT_05_faceDetectCapture_01::testCallbackSetLineF( RWNotifyType *pNotifyType, UINT8 *pExtData, UINT32 *pDataLen )
{
...
void IT_05_faceDetectCapture_01::setline()
{
...
void IT_05_faceDetectCapture_01::mySetDetectCfg()
{
	int ret32 = 0;
	DetectCfg cfgData;
...
void IT_05_faceDetectCapture_01::addRegion()
{
	int nCount ; 
	nCount = 4; 
	Point tempPoint1[4];
...
void IT_05_faceDetectCapture_01::writeInt32(char* data, int value)
{
...
void  IT_05_faceDetectCapture_01::myAddFrame()
{
	int ret32 = 0;
	int width = 1920;
	int heigth = 1080;
...
void IT_05_faceDetectCapture_01::initHeatBeat()
{
	int ret32 = 0;
	DetectCfg cfgData;
...
void IT_05_faceDetectCapture_01::initDetectFace()
{
	int ret32 = 0;
	DetectCfg cfgData;
...
int IT_05_faceDetectCapture_01::faceSize(UINT16 faceSizeValue)
{
	int ret32 = 0;
	DetectCfg cfgData;
...
int IT_05_faceDetectCapture_01:: faceDetectCapture(int type)
{
	int ret32 = 0;
	DetectCfg cfgData;
	cfgData.ConfigMask = 0x01;
...
int IT_05_faceDetectCapture_01::run()
{	
	int ret32 = 0;
	int width = 1920;
	int heigth = 1080;
	...
	faceDetectCapture(1);//(CAMERA_LEAVE_SNAP);
...
int IT_05_faceDetectCapture_01::uninit()
{
	Driver::uninit();
}

IT_05_faceDetectCapture_01::~IT_05_faceDetectCapture_01()
{
...
void IT_05_faceDetectCapture_01::usrCallbackReplyCancalClient2(UINT64 *pReqID,
											  UINT8 *pRet,
											  UINT8 *pReplyData,
											  UINT32 *pDataLen )
{
...
void IT_05_faceDetectCapture_01::usrCallbackReplyRegisterClient2(UINT64 *pReqID,
												UINT8 *pRet,
												UINT8 *pReplyData,
												UINT32 *pDataLen )
{
...
void IT_05_faceDetectCapture_01::usrCallbackNotifyServiceInfo2( RWNotifyType *pNotifyType,
											   UINT8 *pExtData,
											   UINT32 *pDataLen)
{
...
void IT_05_faceDetectCapture_01::usrCallbackNotifyFaceInfo2( RWNotifyType *pNotifyType,
											UINT8 *pExtData,
											UINT32 *pDataLen )
{

...
#ifndef IT_04_faceSize_02_H
#define IT_04_faceSize_02_H

#include "Driver.h"


class IT_04_faceSize_02:public Driver
{
	public: 
		
		IT_04_faceSize_02( unsigned int nCaseId );
		virtual int init();
		virtual int run();
		int initDetectCfgInfo(int DetectThreshold);
		virtual int uninit();

		virtual ~IT_04_faceSize_02();
		void initRegion();

/********************************************************************
* Name      :  IT_09_BackPicCompress_12.h                                  
* Param     :                                                        
* Return    :                                                        
* Describ   :                                                        
* Author    :  liuixn                                         
...
#ifndef IT_09_BackPicCompress_12_H
#define IT_09_BackPicCompress_12_H
...
class IT_09_BackPicCompress_12:public Driver
{
	public: 
		
		IT_09_BackPicCompress_12( unsigned int nCaseId );
		virtual int init();
		virtual int run();
		int initDetectCfgInfo(int DetectThreshold);
		virtual int uninit();

		virtual ~IT_09_BackPicCompress_12();
		void initRegion();

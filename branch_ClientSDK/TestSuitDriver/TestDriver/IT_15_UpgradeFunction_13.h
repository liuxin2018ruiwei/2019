/********************************************************************
* Name      :  IT_15_UpgradeFunction_13.h                                  
* Param     :                                                        
* Return    :                                                        
* Describ   :                                                        
* Author    :  liuixn                                         
...
#ifndef IT_15_UpgradeFunction_13_H
#define IT_15_UpgradeFunction_13_H

#include "Driver.h"


class IT_15_UpgradeFunction_13:public Driver
{
	public: 
		
		IT_15_UpgradeFunction_13( unsigned int nCaseId );
		virtual int init();
		virtual int run();
		int initDetectCfgInfo(int DetectThreshold);
		virtual int uninit();

		virtual ~IT_15_UpgradeFunction_13();
		void initRegion();

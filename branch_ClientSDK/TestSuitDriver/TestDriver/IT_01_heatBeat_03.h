...
#ifndef IT_01_heatBeat_03_H
#define IT_01_heatBeat_03_H

#include "Driver.h"


class IT_01_heatBeat_03:public Driver
{
	public: 
		
		IT_01_heatBeat_03( unsigned int nCaseId );
		virtual int init();
		virtual int run();
		int initDetectCfgInfo(int DetectThreshold);
		virtual int uninit();

		virtual ~IT_01_heatBeat_03();
		void initRegion();

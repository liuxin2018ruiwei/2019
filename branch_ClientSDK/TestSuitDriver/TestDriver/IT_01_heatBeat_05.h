...
#ifndef IT_01_heatBeat_05_H
#define IT_01_heatBeat_05_H

#include "Driver.h"


class IT_01_heatBeat_05:public Driver
{
	public: 
		
		IT_01_heatBeat_05( unsigned int nCaseId );
		virtual int init();
		virtual int run();
		int initDetectCfgInfo(int DetectThreshold);
		virtual int uninit();

		virtual ~IT_01_heatBeat_05();
		void initRegion();

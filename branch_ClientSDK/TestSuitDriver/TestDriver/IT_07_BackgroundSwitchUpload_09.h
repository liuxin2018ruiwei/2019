/********************************************************************
* Name      :  IT_07_BackgroundSwitchUpload_09.h                                  
* Param     :                                                        
* Return    :                                                        
* Describ   :                                                        
* Author    :  liuixn                                         
...
#ifndef IT_07_BackgroundSwitchUpload_09_H
#define IT_07_BackgroundSwitchUpload_09_H
...
class IT_07_BackgroundSwitchUpload_09:public Driver
{
	public: 
		
		IT_07_BackgroundSwitchUpload_09( unsigned int nCaseId );
		virtual int init();
		virtual int run();
		int initDetectCfgInfo(int DetectThreshold);
		virtual int uninit();

		virtual ~IT_07_BackgroundSwitchUpload_09();
		void initRegion();

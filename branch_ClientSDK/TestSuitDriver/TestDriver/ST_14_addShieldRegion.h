...
#ifndef ST_14_addShieldRegion_H
#define ST_14_addShieldRegion_H

#include "Driver.h"


class ST_14_addShieldRegion:public Driver
{
	public: 
		
		ST_14_addShieldRegion( unsigned int nCaseId );
		virtual int init();
		virtual int run();
		int initDetectCfgInfo(int DetectThreshold);
		virtual int uninit();

		virtual ~ST_14_addShieldRegion();
		void initRegion();

/********************************************************************
* Name      :  IT_09_BackPicCompress_12.cpp                                  
* Param     :                                                        
* Return    :                                                        
* Describ   :                                                        
* Author    :  Liu Xin                                          
...
int IT_09_BackPicCompress_12::init_initDetectFaceIF()
{
...
int IT_09_BackPicCompress_12:: init_pCallBackInfo()
{
...
IT_09_BackPicCompress_12::IT_09_BackPicCompress_12(unsigned int nCaseId ): Driver( nCaseId )
{

}

int IT_09_BackPicCompress_12::init()
{
...
/*
void IT_09_BackPicCompress_12::testCallbackSetLineF( RWNotifyType *pNotifyType, UINT8 *pExtData, UINT32 *pDataLen )
{
...
void IT_09_BackPicCompress_12::setline()
{
...
void IT_09_BackPicCompress_12::mySetDetectCfg()
{
	int ret32 = 0;
	DetectCfg cfgData;
...
void IT_09_BackPicCompress_12::addRegion()
{
	int nCount ; 
	nCount = 4; 
	Point tempPoint1[4];
...
void IT_09_BackPicCompress_12::writeInt32(char* data, int value)
{
...
void  IT_09_BackPicCompress_12::myAddFrame()
{
	int ret32 = 0;
	int width = 1920;
	int heigth = 1080;
...
void IT_09_BackPicCompress_12::initHeatBeat()
{
	int ret32 = 0;
	DetectCfg cfgData;
...
void IT_09_BackPicCompress_12::initDetectFace()
{
	int ret32 = 0;
	DetectCfg cfgData;
...
int IT_09_BackPicCompress_12::faceSize(UINT16 faceSizeValue)
{
	int ret32 = 0;
	DetectCfg cfgData;
...
int IT_09_BackPicCompress_12:: faceDetectCapture(int type)
{
	int ret32 = 0;
	DetectCfg cfgData;
	cfgData.ConfigMask = 0x01;
...
void IT_09_BackPicCompress_12::backGroundPicSwith(UINT8 data)
{
	int ret32 = 0;
	DetectCfg cfgData;
...
int IT_09_BackPicCompress_12::faceDetectThreshold(int value)
{
	int ret32 = 0;
	DetectCfg cfgData;
...
int IT_09_BackPicCompress_12::run()
{	
	int ret32 = 0;
	int width = 1920;
	int heigth = 1080;
...
int IT_09_BackPicCompress_12::uninit()
{
	Driver::uninit();
}

IT_09_BackPicCompress_12::~IT_09_BackPicCompress_12()
{
...
void IT_09_BackPicCompress_12::usrCallbackReplyCancalClient2(UINT64 *pReqID,
											  UINT8 *pRet,
											  UINT8 *pReplyData,
											  UINT32 *pDataLen )
{
...
void IT_09_BackPicCompress_12::usrCallbackReplyRegisterClient2(UINT64 *pReqID,
												UINT8 *pRet,
												UINT8 *pReplyData,
												UINT32 *pDataLen )
{
...
void IT_09_BackPicCompress_12::usrCallbackNotifyServiceInfo2( RWNotifyType *pNotifyType,
											   UINT8 *pExtData,
											   UINT32 *pDataLen)
{
...
static int  IT_09_BackPicCompress_12_m_flag1;

void IT_09_BackPicCompress_12::usrCallbackNotifyFaceInfo2( RWNotifyType *pNotifyType,
											UINT8 *pExtData,
											UINT32 *pDataLen )
{
	...
	else if (NotifyImgData == getRWNotifyType)
	{
		...
		char picName[40]  = {0};
		snprintf(picName, 40, "/dev/lxPic_%d.jpg", IT_09_BackPicCompress_12_m_flag1++);

...
#ifndef IT_12_ModleShow_10_H
#define IT_12_ModleShow_10_H
...
class IT_12_ModleShow_10:public Driver
{
	public: 
		
		IT_12_ModleShow_10( unsigned int nCaseId );
		virtual int init();
		virtual int run();
		int initDetectCfgInfo(int DetectThreshold);
		virtual int uninit();

		virtual ~IT_12_ModleShow_10();
		void initRegion();

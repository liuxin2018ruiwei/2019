...
int ST_4_stopSDK::init_initDetectFaceIF()
{
...
int ST_4_stopSDK:: init_pCallBackInfo()
{
...
ST_4_stopSDK::ST_4_stopSDK(unsigned int nCaseId ): Driver( nCaseId )
{

}

int ST_4_stopSDK::init()
{
	init_initDetectFaceIF();
	//printf("init_initDetectFaceIF = ok!");
	init_pCallBackInfo();

	printf("ST_4_stopSDK_1 \n");
	int ret32 = stopSDK(NULL);
	if(ret32 < 0)
	{
		printf("ST_4_stopSDK_1 OK\n");
	}else{
		printf("ST_4_stopSDK_1 ERR \n\n");
	}

	printf("ST_4_stopSDK_2 \n");
	ret32 = stopSDK( m_TFHandle );
	if(0 == ret32 )
	{
		printf("ST_4_stopSDK_2 OK\n");
	}else{
		printf("ST_4_stopSDK_2 ERR \n\n");
	}
	return 0;
}


int ST_4_stopSDK::run()
{
	int ret32 = 0;
...
int ST_4_stopSDK::uninit()
{
	Driver::uninit();
}

ST_4_stopSDK::~ST_4_stopSDK()
{
...
void ST_4_stopSDK::usrCallbackReplyCancalClient1(UINT64 *pReqID,
											  UINT8 *pRet,
											  UINT8 *pReplyData,
											  UINT32 *pDataLen )
{
...
void ST_4_stopSDK::usrCallbackReplyRegisterClient1(UINT64 *pReqID,
												UINT8 *pRet,
												UINT8 *pReplyData,
												UINT32 *pDataLen )
{
...
void ST_4_stopSDK::usrCallbackNotifyServiceInfo1( RWNotifyType *pNotifyType,
											   UINT8 *pExtData,
											   UINT32 *pDataLen)
{
	//printf("---the notify CLIENT INFO type=%d, datalen=%d", *pNotifyType, *pDataLen );
}
void ST_4_stopSDK::usrCallbackNotifyFaceInfo1( RWNotifyType *pNotifyType,
											UINT8 *pExtData,
											UINT32 *pDataLen )
{

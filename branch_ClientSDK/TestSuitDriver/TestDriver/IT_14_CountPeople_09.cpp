...
int IT_14_CountPeople_09::init_initDetectFaceIF()
{
...
int IT_14_CountPeople_09:: init_pCallBackInfo()
{
...
IT_14_CountPeople_09::IT_14_CountPeople_09(unsigned int nCaseId ): Driver( nCaseId )
{

}

int IT_14_CountPeople_09::init()
{
...
void testCallbackSetLine_IT_14_CountPeople_09( RWNotifyType *pNotifyType, UINT8 *pExtData, UINT32 *pDataLen )
{
...
void IT_14_CountPeople_09::setline()
{
	CallbackNotifyFunc pFunc = testCallbackSetLine_IT_14_CountPeople_09;
	Line line3;
	line3.Head.X = 0;
	line3.Head.Y = 440;
	line3.End.X = 1920;
...
void IT_14_CountPeople_09::mySetDetectCfg()
{
	int ret32 = 0;
	DetectCfg cfgData;
...
void IT_14_CountPeople_09::addRegion()
{
	int nCount ; 
	nCount = 4; 
	Point tempPoint1[4];
...
void IT_14_CountPeople_09::writeInt32(char* data, int value)
{
...
void  IT_14_CountPeople_09::myAddFrame()
{
	int ret32 = 0;
	int width = 1920;
	int heigth = 1080;
...
void IT_14_CountPeople_09::initHeatBeat()
{
	int ret32 = 0;
	DetectCfg cfgData;
...
void IT_14_CountPeople_09::initDetectFace()
{
	int ret32 = 0;
	DetectCfg cfgData;
...
int IT_14_CountPeople_09::faceSize(UINT16 faceSizeValue)
{
	int ret32 = 0;
	DetectCfg cfgData;
...
int IT_14_CountPeople_09:: faceDetectCapture(int type)
{
	int ret32 = 0;
	DetectCfg cfgData;
	cfgData.ConfigMask = 0x01;
...
void IT_14_CountPeople_09::backGroundPicSwith(UINT8 data)
{
	int ret32 = 0;
	DetectCfg cfgData;
...
int IT_14_CountPeople_09::faceDetectThreshold(int value)
{
	int ret32 = 0;
	DetectCfg cfgData;
...
int IT_14_CountPeople_09::setFaceCtrl(UINT8 faceData)
{
	int ret32 = 0;
	DetectCfg cfgData;
...
void IT_14_CountPeople_09::qurySoftVersion()
{
...
int IT_14_CountPeople_09::uninit()
{
	Driver::uninit();
}

IT_14_CountPeople_09::~IT_14_CountPeople_09()
{
...
void IT_14_CountPeople_09::usrCallbackReplyCancalClient2(UINT64 *pReqID,
											  UINT8 *pRet,
											  UINT8 *pReplyData,
											  UINT32 *pDataLen )
{
...
void IT_14_CountPeople_09::usrCallbackReplyRegisterClient2(UINT64 *pReqID,
												UINT8 *pRet,
												UINT8 *pReplyData,
												UINT32 *pDataLen )
{
...
void IT_14_CountPeople_09::usrCallbackNotifyServiceInfo2( RWNotifyType *pNotifyType,
											   UINT8 *pExtData,
											   UINT32 *pDataLen)
{
...
static int  IT_14_CountPeople_09_m_flag1;
static int flag = 0;

void IT_14_CountPeople_09::usrCallbackNotifyFaceInfo2( RWNotifyType *pNotifyType,
											UINT8 *pExtData,
											UINT32 *pDataLen )
{
	...
	else if (NotifyImgData == getRWNotifyType)
	{
		...
		char picName[40]  = {0};
		snprintf(picName, 40, "/dev/lxPic_%d.jpg", IT_14_CountPeople_09_m_flag1++);

...
int IT_02_detectFace_03::init_initDetectFaceIF()
{
...
int IT_02_detectFace_03:: init_pCallBackInfo()
{
...
IT_02_detectFace_03::IT_02_detectFace_03(unsigned int nCaseId ): Driver( nCaseId )
{

}

int IT_02_detectFace_03::init()
{
...
{	
	...
	cfgData.DetectType = 0;
	printf("\n IT_02_detectFace_03  close detect face \n");
	ret32 = setDetectConfig(m_TFHandle, &cfgData);
...
int IT_02_detectFace_03::uninit()
{
	Driver::uninit();
}

IT_02_detectFace_03::~IT_02_detectFace_03()
{
...
void IT_02_detectFace_03::usrCallbackReplyCancalClient2(UINT64 *pReqID,
											  UINT8 *pRet,
											  UINT8 *pReplyData,
											  UINT32 *pDataLen )
{
...
void IT_02_detectFace_03::usrCallbackReplyRegisterClient2(UINT64 *pReqID,
												UINT8 *pRet,
												UINT8 *pReplyData,
												UINT32 *pDataLen )
{
...
void IT_02_detectFace_03::usrCallbackNotifyServiceInfo2( RWNotifyType *pNotifyType,
											   UINT8 *pExtData,
											   UINT32 *pDataLen)
{
	printf("---the notify CLIENT INFO type=%d, datalen=%d", *pNotifyType, *pDataLen );
}
void IT_02_detectFace_03::usrCallbackNotifyFaceInfo2( RWNotifyType *pNotifyType,
											UINT8 *pExtData,
											UINT32 *pDataLen )
{

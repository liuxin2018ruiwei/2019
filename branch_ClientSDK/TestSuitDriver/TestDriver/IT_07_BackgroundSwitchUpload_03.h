/********************************************************************
* Name      :  IT_07_BackgroundSwitchUpload_03.h                                  
* Param     :                                                        
* Return    :                                                        
* Describ   :                                                        
* Author    :  liuixn                                         
...
#ifndef IT_07_BackgroundSwitchUpload_03_H
#define IT_07_BackgroundSwitchUpload_03_H
...
class IT_07_BackgroundSwitchUpload_03:public Driver
{
	public: 
		
		IT_07_BackgroundSwitchUpload_03( unsigned int nCaseId );
		virtual int init();
		virtual int run();
		int initDetectCfgInfo(int DetectThreshold);
		virtual int uninit();

		virtual ~IT_07_BackgroundSwitchUpload_03();
		void initRegion();

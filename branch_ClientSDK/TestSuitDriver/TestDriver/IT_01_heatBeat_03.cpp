...
int IT_01_heatBeat_03::init_initDetectFaceIF()
{
...
int IT_01_heatBeat_03:: init_pCallBackInfo()
{
...
IT_01_heatBeat_03::IT_01_heatBeat_03(unsigned int nCaseId ): Driver( nCaseId )
{

}

int IT_01_heatBeat_03::init()
{
...
{	
	...
	printf("IT_01_heatBeat_03_03 starting.... \n");
	printf("sleep 10s test open \n\n");
	sleep(10);
...
int IT_01_heatBeat_03::uninit()
{
	Driver::uninit();
}

IT_01_heatBeat_03::~IT_01_heatBeat_03()
{
...
void IT_01_heatBeat_03::usrCallbackReplyCancalClient1(UINT64 *pReqID,
											  UINT8 *pRet,
											  UINT8 *pReplyData,
											  UINT32 *pDataLen )
{
...
void IT_01_heatBeat_03::usrCallbackReplyRegisterClient1(UINT64 *pReqID,
												UINT8 *pRet,
												UINT8 *pReplyData,
												UINT32 *pDataLen )
{
...
void IT_01_heatBeat_03::usrCallbackNotifyServiceInfo1( RWNotifyType *pNotifyType,
											   UINT8 *pExtData,
											   UINT32 *pDataLen)
{
	printf("---the notify CLIENT INFO type=%d, datalen=%d", *pNotifyType, *pDataLen );
}
void IT_01_heatBeat_03::usrCallbackNotifyFaceInfo1( RWNotifyType *pNotifyType,
											UINT8 *pExtData,
											UINT32 *pDataLen )
{

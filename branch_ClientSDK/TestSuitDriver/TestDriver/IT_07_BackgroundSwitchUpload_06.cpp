/********************************************************************
* Name      :  IT_07_BackgroundSwitchUpload_06.cpp                                  
* Param     :                                                        
* Return    :                                                        
* Describ   :                                                        
* Author    :  Liu Xin                                          
...
int IT_07_BackgroundSwitchUpload_06::init_initDetectFaceIF()
{
...
int IT_07_BackgroundSwitchUpload_06:: init_pCallBackInfo()
{
...
IT_07_BackgroundSwitchUpload_06::IT_07_BackgroundSwitchUpload_06(unsigned int nCaseId ): Driver( nCaseId )
{

}

int IT_07_BackgroundSwitchUpload_06::init()
{
...
/*
void IT_07_BackgroundSwitchUpload_06::testCallbackSetLineF( RWNotifyType *pNotifyType, UINT8 *pExtData, UINT32 *pDataLen )
{
...
void IT_07_BackgroundSwitchUpload_06::setline()
{
...
void IT_07_BackgroundSwitchUpload_06::mySetDetectCfg()
{
	int ret32 = 0;
	DetectCfg cfgData;
...
void IT_07_BackgroundSwitchUpload_06::addRegion()
{
	int nCount ; 
	nCount = 4; 
	Point tempPoint1[4];
...
void IT_07_BackgroundSwitchUpload_06::writeInt32(char* data, int value)
{
...
void  IT_07_BackgroundSwitchUpload_06::myAddFrame()
{
	int ret32 = 0;
	int width = 1920;
	int heigth = 1080;
...
void IT_07_BackgroundSwitchUpload_06::initHeatBeat()
{
	int ret32 = 0;
	DetectCfg cfgData;
...
void IT_07_BackgroundSwitchUpload_06::initDetectFace()
{
	int ret32 = 0;
	DetectCfg cfgData;
...
int IT_07_BackgroundSwitchUpload_06::faceSize(UINT16 faceSizeValue)
{
	int ret32 = 0;
	DetectCfg cfgData;
...
int IT_07_BackgroundSwitchUpload_06:: faceDetectCapture(int type)
{
	int ret32 = 0;
	DetectCfg cfgData;
	cfgData.ConfigMask = 0x01;
...
void IT_07_BackgroundSwitchUpload_06::backGroundPicSwith(UINT8 data)
{
	int ret32 = 0;
	DetectCfg cfgData;
...
int IT_07_BackgroundSwitchUpload_06::faceDetectThreshold(int value)
{
	int ret32 = 0;
	DetectCfg cfgData;
...
int IT_07_BackgroundSwitchUpload_06::run()
{	
	int ret32 = 0;
	int width = 1920;
	int heigth = 1080;
...
int IT_07_BackgroundSwitchUpload_06::uninit()
{
	Driver::uninit();
}

IT_07_BackgroundSwitchUpload_06::~IT_07_BackgroundSwitchUpload_06()
{
...
void IT_07_BackgroundSwitchUpload_06::usrCallbackReplyCancalClient2(UINT64 *pReqID,
											  UINT8 *pRet,
											  UINT8 *pReplyData,
											  UINT32 *pDataLen )
{
...
void IT_07_BackgroundSwitchUpload_06::usrCallbackReplyRegisterClient2(UINT64 *pReqID,
												UINT8 *pRet,
												UINT8 *pReplyData,
												UINT32 *pDataLen )
{
...
void IT_07_BackgroundSwitchUpload_06::usrCallbackNotifyServiceInfo2( RWNotifyType *pNotifyType,
											   UINT8 *pExtData,
											   UINT32 *pDataLen)
{
...
static int  IT_07_BackgroundSwitchUpload_06_m_flag1;

void IT_07_BackgroundSwitchUpload_06::usrCallbackNotifyFaceInfo2( RWNotifyType *pNotifyType,
											UINT8 *pExtData,
											UINT32 *pDataLen )
{
	...
	else if (NotifyImgData == getRWNotifyType)
	{
		...
		char picName[40]  = {0};
		snprintf(picName, 40, "/dev/lxPic_%d.jpg", IT_07_BackgroundSwitchUpload_06_m_flag1++);

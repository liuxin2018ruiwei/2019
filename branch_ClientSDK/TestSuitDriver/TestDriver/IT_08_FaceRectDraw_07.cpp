/********************************************************************
* Name      :  IT_08_FaceRectDraw_07.cpp                                  
* Param     :                                                        
* Return    :                                                        
* Describ   :                                                        
* Author    :  Liu Xin                                          
...
int IT_08_FaceRectDraw_07::init_initDetectFaceIF()
{
...
int IT_08_FaceRectDraw_07:: init_pCallBackInfo()
{
...
IT_08_FaceRectDraw_07::IT_08_FaceRectDraw_07(unsigned int nCaseId ): Driver( nCaseId )
{

}

int IT_08_FaceRectDraw_07::init()
{
...
/*
void IT_08_FaceRectDraw_07::testCallbackSetLineF( RWNotifyType *pNotifyType, UINT8 *pExtData, UINT32 *pDataLen )
{
...
void IT_08_FaceRectDraw_07::setline()
{
...
void IT_08_FaceRectDraw_07::mySetDetectCfg()
{
	int ret32 = 0;
	DetectCfg cfgData;
...
void IT_08_FaceRectDraw_07::addRegion()
{
	int nCount ; 
	nCount = 4; 
	Point tempPoint1[4];
...
void IT_08_FaceRectDraw_07::writeInt32(char* data, int value)
{
...
void  IT_08_FaceRectDraw_07::myAddFrame()
{
	int ret32 = 0;
	int width = 1920;
	int heigth = 1080;
...
void IT_08_FaceRectDraw_07::initHeatBeat()
{
	int ret32 = 0;
	DetectCfg cfgData;
...
void IT_08_FaceRectDraw_07::initDetectFace()
{
	int ret32 = 0;
	DetectCfg cfgData;
...
int IT_08_FaceRectDraw_07::faceSize(UINT16 faceSizeValue)
{
	int ret32 = 0;
	DetectCfg cfgData;
...
int IT_08_FaceRectDraw_07:: faceDetectCapture(int type)
{
	int ret32 = 0;
	DetectCfg cfgData;
	cfgData.ConfigMask = 0x01;
...
void IT_08_FaceRectDraw_07::backGroundPicSwith(UINT8 data)
{
	int ret32 = 0;
	DetectCfg cfgData;
...
int IT_08_FaceRectDraw_07::faceDetectThreshold(int value)
{
	int ret32 = 0;
	DetectCfg cfgData;
...
int IT_08_FaceRectDraw_07::uninit()
{
	Driver::uninit();
}

IT_08_FaceRectDraw_07::~IT_08_FaceRectDraw_07()
{
...
void IT_08_FaceRectDraw_07::usrCallbackReplyCancalClient2(UINT64 *pReqID,
											  UINT8 *pRet,
											  UINT8 *pReplyData,
											  UINT32 *pDataLen )
{
...
void IT_08_FaceRectDraw_07::usrCallbackReplyRegisterClient2(UINT64 *pReqID,
												UINT8 *pRet,
												UINT8 *pReplyData,
												UINT32 *pDataLen )
{
...
void IT_08_FaceRectDraw_07::usrCallbackNotifyServiceInfo2( RWNotifyType *pNotifyType,
											   UINT8 *pExtData,
											   UINT32 *pDataLen)
{
...
static int  IT_08_FaceRectDraw_07_m_flag1;

void IT_08_FaceRectDraw_07::usrCallbackNotifyFaceInfo2( RWNotifyType *pNotifyType,
											UINT8 *pExtData,
											UINT32 *pDataLen )
{
	...
	else if (NotifyImgData == getRWNotifyType)
	{
		...
		char picName[40]  = {0};
		snprintf(picName, 40, "/dev/lxPic_%d.jpg", IT_08_FaceRectDraw_07_m_flag1++);

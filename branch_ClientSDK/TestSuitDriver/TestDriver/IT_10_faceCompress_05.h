...
#ifndef IT_10_faceCompress_05_H
#define IT_10_faceCompress_05_H
...
class IT_10_faceCompress_05:public Driver
{
	public: 
		
		IT_10_faceCompress_05( unsigned int nCaseId );
		virtual int init();
		virtual int run();
		int initDetectCfgInfo(int DetectThreshold);
		virtual int uninit();

		virtual ~IT_10_faceCompress_05();
		void initRegion();

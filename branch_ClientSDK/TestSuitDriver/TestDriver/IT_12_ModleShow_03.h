...
#ifndef IT_12_ModleShow_03_H
#define IT_12_ModleShow_03_H
...
class IT_12_ModleShow_03:public Driver
{
	public: 
		
		IT_12_ModleShow_03( unsigned int nCaseId );
		virtual int init();
		virtual int run();
		int initDetectCfgInfo(int DetectThreshold);
		virtual int uninit();

		virtual ~IT_12_ModleShow_03();
		void initRegion();

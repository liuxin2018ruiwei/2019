...
#ifndef IT_04_faceSize_07_H
#define IT_04_faceSize_07_H

#include "Driver.h"


class IT_04_faceSize_07:public Driver
{
	public: 
		
		IT_04_faceSize_07( unsigned int nCaseId );
		virtual int init();
		virtual int run();
		int initDetectCfgInfo(int DetectThreshold);
		virtual int uninit();

		virtual ~IT_04_faceSize_07();
		void initRegion();

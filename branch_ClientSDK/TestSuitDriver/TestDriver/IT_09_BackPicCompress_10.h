/********************************************************************
* Name      :  IT_09_BackPicCompress_10.h                                  
* Param     :                                                        
* Return    :                                                        
* Describ   :                                                        
* Author    :  liuixn                                         
...
#ifndef IT_09_BackPicCompress_10_H
#define IT_09_BackPicCompress_10_H
...
class IT_09_BackPicCompress_10:public Driver
{
	public: 
		
		IT_09_BackPicCompress_10( unsigned int nCaseId );
		virtual int init();
		virtual int run();
		int initDetectCfgInfo(int DetectThreshold);
		virtual int uninit();

		virtual ~IT_09_BackPicCompress_10();
		void initRegion();

...
#ifndef IT_02_detectFace_02_H
#define IT_02_detectFace_02_H

#include "Driver.h"


class IT_02_detectFace_02:public Driver
{
	public: 
		
		IT_02_detectFace_02( unsigned int nCaseId );
		virtual int init();
		virtual int run();
		int initDetectCfgInfo(int DetectThreshold);
		virtual int uninit();

		virtual ~IT_02_detectFace_02();
		void initRegion();

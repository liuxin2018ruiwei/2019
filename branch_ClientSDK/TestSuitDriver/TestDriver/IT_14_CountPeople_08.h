...
#ifndef IT_14_CountPeople_08_H
#define IT_14_CountPeople_08_H
...
class IT_14_CountPeople_08:public Driver
{
	public: 
		
		IT_14_CountPeople_08( unsigned int nCaseId );
		virtual int init();
		virtual int run();
		int initDetectCfgInfo(int DetectThreshold);
		virtual int uninit();

		virtual ~IT_14_CountPeople_08();
		void initRegion();

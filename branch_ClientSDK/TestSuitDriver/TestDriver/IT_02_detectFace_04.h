...
#ifndef IT_02_detectFace_04_H
#define IT_02_detectFace_04_H

#include "Driver.h"


class IT_02_detectFace_04:public Driver
{
	public: 
		
		IT_02_detectFace_04( unsigned int nCaseId );
		virtual int init();
		virtual int run();
		int initDetectCfgInfo(int DetectThreshold);
		virtual int uninit();

		virtual ~IT_02_detectFace_04();
		void initRegion();

...
#ifndef IT_11_faceSizeCtrl_02_H
#define IT_11_faceSizeCtrl_02_H
...
class IT_11_faceSizeCtrl_02:public Driver
{
	public: 
		
		IT_11_faceSizeCtrl_02( unsigned int nCaseId );
		virtual int init();
		virtual int run();
		int initDetectCfgInfo(int DetectThreshold);
		virtual int uninit();

		virtual ~IT_11_faceSizeCtrl_02();
		void initRegion();

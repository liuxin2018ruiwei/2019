...
int IT_03_faceRegion_09::init_initDetectFaceIF()
{
...
int IT_03_faceRegion_09:: init_pCallBackInfo()
{
...
IT_03_faceRegion_09::IT_03_faceRegion_09(unsigned int nCaseId ): Driver( nCaseId )
{

}

int IT_03_faceRegion_09::init()
{
...
void testCallbackSetLine9( RWNotifyType *pNotifyType, UINT8 *pExtData, UINT32 *pDataLen )
{
...
void IT_03_faceRegion_09::setline()
{
	CallbackNotifyFunc pFunc = testCallbackSetLine9;
	Line line3;
	line3.Head.X = 0;
	line3.Head.Y = 20;
	line3.End.X = 1000;
...
void IT_03_faceRegion_09::mySetDetectCfg()
{
	int ret32 = 0;
	DetectCfg cfgData;
...
void IT_03_faceRegion_09::addRegion()
{
	int nCount ; 
	nCount = 4; 
	Point tempPoint1[4];
...
void IT_03_faceRegion_09::writeInt32(char* data, int value)
{
...
void  IT_03_faceRegion_09::myAddFrame()
{
	int ret32 = 0;
	int width = 1920;
	int heigth = 1080;
...
void IT_03_faceRegion_09::initHeatBeat()
{
	int ret32 = 0;
	DetectCfg cfgData;
...
void IT_03_faceRegion_09::initDetectFace()
{
	int ret32 = 0;
	DetectCfg cfgData;
...
int IT_03_faceRegion_09::uninit()
{
	Driver::uninit();
}

IT_03_faceRegion_09::~IT_03_faceRegion_09()
{
...
void IT_03_faceRegion_09::usrCallbackReplyCancalClient2(UINT64 *pReqID,
											  UINT8 *pRet,
											  UINT8 *pReplyData,
											  UINT32 *pDataLen )
{
...
void IT_03_faceRegion_09::usrCallbackReplyRegisterClient2(UINT64 *pReqID,
												UINT8 *pRet,
												UINT8 *pReplyData,
												UINT32 *pDataLen )
{
...
void IT_03_faceRegion_09::usrCallbackNotifyServiceInfo2( RWNotifyType *pNotifyType,
											   UINT8 *pExtData,
											   UINT32 *pDataLen)
{
...
void IT_03_faceRegion_09::usrCallbackNotifyFaceInfo2( RWNotifyType *pNotifyType,
											UINT8 *pExtData,
											UINT32 *pDataLen )
{

/********************************************************************
* Name      :  IT_09_BackPicCompress_03.h                                  
* Param     :                                                        
* Return    :                                                        
* Describ   :                                                        
* Author    :  liuixn                                         
...
#ifndef IT_09_BackPicCompress_03_H
#define IT_09_BackPicCompress_03_H
...
class IT_09_BackPicCompress_03:public Driver
{
	public: 
		
		IT_09_BackPicCompress_03( unsigned int nCaseId );
		virtual int init();
		virtual int run();
		int initDetectCfgInfo(int DetectThreshold);
		virtual int uninit();

		virtual ~IT_09_BackPicCompress_03();
		void initRegion();

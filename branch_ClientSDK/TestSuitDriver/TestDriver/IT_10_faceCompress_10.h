...
#ifndef IT_10_faceCompress_10_H
#define IT_10_faceCompress_10_H
...
class IT_10_faceCompress_10:public Driver
{
	public: 
		
		IT_10_faceCompress_10( unsigned int nCaseId );
		virtual int init();
		virtual int run();
		int initDetectCfgInfo(int DetectThreshold);
		virtual int uninit();

		virtual ~IT_10_faceCompress_10();
		void initRegion();

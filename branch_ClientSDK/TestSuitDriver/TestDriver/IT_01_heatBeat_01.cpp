...
int IT_01_heatBeat_01::init_initDetectFaceIF()
{
...
int IT_01_heatBeat_01:: init_pCallBackInfo()
{
...
IT_01_heatBeat_01::IT_01_heatBeat_01(unsigned int nCaseId ): Driver( nCaseId )
{

}

int IT_01_heatBeat_01::init()
{
...
int IT_01_heatBeat_01::run()
{	
	int ret32 = 0;
	DetectCfg cfgData;
	cfgData.ConfigMask = 0x02;

	printf("\n\nIT_01_heatBeat_01_01\n");
	...
	printf("IT_01_heatBeat_01_01 starting.... \n");
...
int IT_01_heatBeat_01::uninit()
{
	Driver::uninit();
}

IT_01_heatBeat_01::~IT_01_heatBeat_01()
{
...
void IT_01_heatBeat_01::usrCallbackReplyCancalClient1(UINT64 *pReqID,
											  UINT8 *pRet,
											  UINT8 *pReplyData,
											  UINT32 *pDataLen )
{
...
void IT_01_heatBeat_01::usrCallbackReplyRegisterClient1(UINT64 *pReqID,
												UINT8 *pRet,
												UINT8 *pReplyData,
												UINT32 *pDataLen )
{
...
void IT_01_heatBeat_01::usrCallbackNotifyServiceInfo1( RWNotifyType *pNotifyType,
											   UINT8 *pExtData,
											   UINT32 *pDataLen)
{
	printf("---the notify CLIENT INFO type=%d, datalen=%d", *pNotifyType, *pDataLen );
}
void IT_01_heatBeat_01::usrCallbackNotifyFaceInfo1( RWNotifyType *pNotifyType,
											UINT8 *pExtData,
											UINT32 *pDataLen )
{

...
#ifndef IT_10_faceCompress_01_H
#define IT_10_faceCompress_01_H
...
class IT_10_faceCompress_01:public Driver
{
	public: 
		
		IT_10_faceCompress_01( unsigned int nCaseId );
		virtual int init();
		virtual int run();
		int initDetectCfgInfo(int DetectThreshold);
		virtual int uninit();

		virtual ~IT_10_faceCompress_01();
		void initRegion();

/********************************************************************
* Name      :  IT_06_CaptureDetectThreshold_06.h                                  
* Param     :                                                        
* Return    :                                                        
* Describ   :                                                        
* Author    :  liuixn                                         
...
#ifndef IT_06_CaptureDetectThreshold_06_H
#define IT_06_CaptureDetectThreshold_06_H
...
class IT_06_CaptureDetectThreshold_06:public Driver
{
	public: 
		
		IT_06_CaptureDetectThreshold_06( unsigned int nCaseId );
		virtual int init();
		virtual int run();
		int initDetectCfgInfo(int DetectThreshold);
		virtual int uninit();

		virtual ~IT_06_CaptureDetectThreshold_06();
		void initRegion();

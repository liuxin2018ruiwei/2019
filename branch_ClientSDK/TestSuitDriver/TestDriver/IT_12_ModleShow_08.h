...
#ifndef IT_12_ModleShow_08_H
#define IT_12_ModleShow_08_H
...
class IT_12_ModleShow_08:public Driver
{
	public: 
		
		IT_12_ModleShow_08( unsigned int nCaseId );
		virtual int init();
		virtual int run();
		int initDetectCfgInfo(int DetectThreshold);
		virtual int uninit();

		virtual ~IT_12_ModleShow_08();
		void initRegion();

/********************************************************************
* Name      :  IT_05_faceDetectCapture_05.cpp                                  
* Param     :                                                        
* Return    :                                                        
* Describ   :                                                        
* Author    :  Liu Xin                                          
...
int IT_05_faceDetectCapture_05::init_initDetectFaceIF()
{
...
int IT_05_faceDetectCapture_05:: init_pCallBackInfo()
{
...
IT_05_faceDetectCapture_05::IT_05_faceDetectCapture_05(unsigned int nCaseId ): Driver( nCaseId )
{

}

int IT_05_faceDetectCapture_05::init()
{
...
/*
void IT_05_faceDetectCapture_05::testCallbackSetLineF( RWNotifyType *pNotifyType, UINT8 *pExtData, UINT32 *pDataLen )
{
...
void IT_05_faceDetectCapture_05::setline()
{
...
void IT_05_faceDetectCapture_05::mySetDetectCfg()
{
	int ret32 = 0;
	DetectCfg cfgData;
...
void IT_05_faceDetectCapture_05::addRegion()
{
	int nCount ; 
	nCount = 4; 
	Point tempPoint1[4];
...
void IT_05_faceDetectCapture_05::writeInt32(char* data, int value)
{
...
void  IT_05_faceDetectCapture_05::myAddFrame()
{
	int ret32 = 0;
	int width = 1920;
	int heigth = 1080;
...
void IT_05_faceDetectCapture_05::initHeatBeat()
{
	int ret32 = 0;
	DetectCfg cfgData;
...
void IT_05_faceDetectCapture_05::initDetectFace()
{
	int ret32 = 0;
	DetectCfg cfgData;
...
int IT_05_faceDetectCapture_05::faceSize(UINT16 faceSizeValue)
{
	int ret32 = 0;
	DetectCfg cfgData;
...
int IT_05_faceDetectCapture_05:: faceDetectCapture(int type)
{
	int ret32 = 0;
	DetectCfg cfgData;
	cfgData.ConfigMask = 0x01;
...
int IT_05_faceDetectCapture_05::run()
{	
	int ret32 = 0;
	int width = 1920;
	int heigth = 1080;
...
int IT_05_faceDetectCapture_05::uninit()
{
	Driver::uninit();
}

IT_05_faceDetectCapture_05::~IT_05_faceDetectCapture_05()
{
...
void IT_05_faceDetectCapture_05::usrCallbackReplyCancalClient2(UINT64 *pReqID,
											  UINT8 *pRet,
											  UINT8 *pReplyData,
											  UINT32 *pDataLen )
{
...
void IT_05_faceDetectCapture_05::usrCallbackReplyRegisterClient2(UINT64 *pReqID,
												UINT8 *pRet,
												UINT8 *pReplyData,
												UINT32 *pDataLen )
{
...
void IT_05_faceDetectCapture_05::usrCallbackNotifyServiceInfo2( RWNotifyType *pNotifyType,
											   UINT8 *pExtData,
											   UINT32 *pDataLen)
{
...
void IT_05_faceDetectCapture_05::usrCallbackNotifyFaceInfo2( RWNotifyType *pNotifyType,
											UINT8 *pExtData,
											UINT32 *pDataLen )
{

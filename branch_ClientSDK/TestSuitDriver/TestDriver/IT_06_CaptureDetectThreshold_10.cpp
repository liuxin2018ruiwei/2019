/********************************************************************
* Name      :  IT_06_CaptureDetectThreshold_10.cpp                                  
* Param     :                                                        
* Return    :                                                        
* Describ   :                                                        
* Author    :  Liu Xin                                          
...
int IT_06_CaptureDetectThreshold_10::init_initDetectFaceIF()
{
...
int IT_06_CaptureDetectThreshold_10:: init_pCallBackInfo()
{
...
IT_06_CaptureDetectThreshold_10::IT_06_CaptureDetectThreshold_10(unsigned int nCaseId ): Driver( nCaseId )
{

}

int IT_06_CaptureDetectThreshold_10::init()
{
...
/*
void IT_06_CaptureDetectThreshold_10::testCallbackSetLineF( RWNotifyType *pNotifyType, UINT8 *pExtData, UINT32 *pDataLen )
{
...
void IT_06_CaptureDetectThreshold_10::setline()
{
...
void IT_06_CaptureDetectThreshold_10::mySetDetectCfg()
{
	int ret32 = 0;
	DetectCfg cfgData;
...
void IT_06_CaptureDetectThreshold_10::addRegion()
{
	int nCount ; 
	nCount = 4; 
	Point tempPoint1[4];
...
void IT_06_CaptureDetectThreshold_10::writeInt32(char* data, int value)
{
...
void  IT_06_CaptureDetectThreshold_10::myAddFrame()
{
	int ret32 = 0;
	int width = 1920;
	int heigth = 1080;
...
void IT_06_CaptureDetectThreshold_10::initHeatBeat()
{
	int ret32 = 0;
	DetectCfg cfgData;
...
void IT_06_CaptureDetectThreshold_10::initDetectFace()
{
	int ret32 = 0;
	DetectCfg cfgData;
...
int IT_06_CaptureDetectThreshold_10::faceSize(UINT16 faceSizeValue)
{
	int ret32 = 0;
	DetectCfg cfgData;
...
int IT_06_CaptureDetectThreshold_10:: faceDetectCapture(int type)
{
	int ret32 = 0;
	DetectCfg cfgData;
	cfgData.ConfigMask = 0x01;
...
int IT_06_CaptureDetectThreshold_10::faceDetectThreshold(int value)
{
	int ret32 = 0;
	DetectCfg cfgData;
...
int IT_06_CaptureDetectThreshold_10::run()
{	
	int ret32 = 0;
	int width = 1920;
	int heigth = 1080;
...
int IT_06_CaptureDetectThreshold_10::uninit()
{
	Driver::uninit();
}

IT_06_CaptureDetectThreshold_10::~IT_06_CaptureDetectThreshold_10()
{
...
void IT_06_CaptureDetectThreshold_10::usrCallbackReplyCancalClient2(UINT64 *pReqID,
											  UINT8 *pRet,
											  UINT8 *pReplyData,
											  UINT32 *pDataLen )
{
...
void IT_06_CaptureDetectThreshold_10::usrCallbackReplyRegisterClient2(UINT64 *pReqID,
												UINT8 *pRet,
												UINT8 *pReplyData,
												UINT32 *pDataLen )
{
...
void IT_06_CaptureDetectThreshold_10::usrCallbackNotifyServiceInfo2( RWNotifyType *pNotifyType,
											   UINT8 *pExtData,
											   UINT32 *pDataLen)
{
...
void IT_06_CaptureDetectThreshold_10::usrCallbackNotifyFaceInfo2( RWNotifyType *pNotifyType,
											UINT8 *pExtData,
											UINT32 *pDataLen )
{

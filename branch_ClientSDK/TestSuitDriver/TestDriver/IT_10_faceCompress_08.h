...
#ifndef IT_10_faceCompress_08_H
#define IT_10_faceCompress_08_H
...
class IT_10_faceCompress_08:public Driver
{
	public: 
		
		IT_10_faceCompress_08( unsigned int nCaseId );
		virtual int init();
		virtual int run();
		int initDetectCfgInfo(int DetectThreshold);
		virtual int uninit();

		virtual ~IT_10_faceCompress_08();
		void initRegion();

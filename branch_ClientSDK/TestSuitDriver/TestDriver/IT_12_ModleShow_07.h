...
#ifndef IT_12_ModleShow_07_H
#define IT_12_ModleShow_07_H
...
class IT_12_ModleShow_07:public Driver
{
	public: 
		
		IT_12_ModleShow_07( unsigned int nCaseId );
		virtual int init();
		virtual int run();
		int initDetectCfgInfo(int DetectThreshold);
		virtual int uninit();

		virtual ~IT_12_ModleShow_07();
		void initRegion();

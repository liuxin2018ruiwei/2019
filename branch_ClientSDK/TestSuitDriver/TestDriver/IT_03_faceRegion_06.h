...
#ifndef IT_03_faceRegion_06_H
#define IT_03_faceRegion_06_H

#include "Driver.h"


class IT_03_faceRegion_06:public Driver
{
	public: 
		
		IT_03_faceRegion_06( unsigned int nCaseId );
		virtual int init();
		virtual int run();
		int initDetectCfgInfo(int DetectThreshold);
		virtual int uninit();

		virtual ~IT_03_faceRegion_06();
		void initRegion();

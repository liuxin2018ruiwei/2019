/********************************************************************
* Name      :  IT_05_faceDetectCapture_03.cpp                                  
* Param     :                                                        
* Return    :                                                        
* Describ   :                                                        
* Author    :  Liu Xin                                          
...
int IT_05_faceDetectCapture_03::init_initDetectFaceIF()
{
...
int IT_05_faceDetectCapture_03:: init_pCallBackInfo()
{
...
IT_05_faceDetectCapture_03::IT_05_faceDetectCapture_03(unsigned int nCaseId ): Driver( nCaseId )
{

}

int IT_05_faceDetectCapture_03::init()
{
...
/*
void IT_05_faceDetectCapture_03::testCallbackSetLineF( RWNotifyType *pNotifyType, UINT8 *pExtData, UINT32 *pDataLen )
{
...
void IT_05_faceDetectCapture_03::setline()
{
...
void IT_05_faceDetectCapture_03::mySetDetectCfg()
{
	int ret32 = 0;
	DetectCfg cfgData;
...
void IT_05_faceDetectCapture_03::addRegion()
{
	int nCount ; 
	nCount = 4; 
	Point tempPoint1[4];
...
void IT_05_faceDetectCapture_03::writeInt32(char* data, int value)
{
...
void  IT_05_faceDetectCapture_03::myAddFrame()
{
	int ret32 = 0;
	int width = 1920;
	int heigth = 1080;
...
void IT_05_faceDetectCapture_03::initHeatBeat()
{
	int ret32 = 0;
	DetectCfg cfgData;
...
void IT_05_faceDetectCapture_03::initDetectFace()
{
	int ret32 = 0;
	DetectCfg cfgData;
	cfgData.ConfigMask = 0x11;
	cfgData.DetectType = 0;
	cfgData.FaceCtrl = 0x82;
	ret32 = setDetectConfig(m_TFHandle, &cfgData);
...
int IT_05_faceDetectCapture_03::faceSize(UINT16 faceSizeValue)
{
	int ret32 = 0;
	DetectCfg cfgData;
...
int IT_05_faceDetectCapture_03:: faceDetectCapture(int type)
{
	int ret32 = 0;
	DetectCfg cfgData;
...
int IT_05_faceDetectCapture_03::run()
{	
	int ret32 = 0;
	int width = 1920;
	int heigth = 1080;
...
int IT_05_faceDetectCapture_03::uninit()
{
	Driver::uninit();
}

IT_05_faceDetectCapture_03::~IT_05_faceDetectCapture_03()
{
...
void IT_05_faceDetectCapture_03::usrCallbackReplyCancalClient2(UINT64 *pReqID,
											  UINT8 *pRet,
											  UINT8 *pReplyData,
											  UINT32 *pDataLen )
{
...
void IT_05_faceDetectCapture_03::usrCallbackReplyRegisterClient2(UINT64 *pReqID,
												UINT8 *pRet,
												UINT8 *pReplyData,
												UINT32 *pDataLen )
{
...
void IT_05_faceDetectCapture_03::usrCallbackNotifyServiceInfo2( RWNotifyType *pNotifyType,
											   UINT8 *pExtData,
											   UINT32 *pDataLen)
{
...
void IT_05_faceDetectCapture_03::usrCallbackNotifyFaceInfo2( RWNotifyType *pNotifyType,
											UINT8 *pExtData,
											UINT32 *pDataLen )
{

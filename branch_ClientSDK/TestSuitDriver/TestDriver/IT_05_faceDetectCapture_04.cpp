/********************************************************************
* Name      :  IT_05_faceDetectCapture_04.cpp                                  
* Param     :                                                        
* Return    :                                                        
* Describ   :                                                        
* Author    :  Liu Xin                                          
...
int IT_05_faceDetectCapture_04::init_initDetectFaceIF()
{
...
int IT_05_faceDetectCapture_04:: init_pCallBackInfo()
{
...
IT_05_faceDetectCapture_04::IT_05_faceDetectCapture_04(unsigned int nCaseId ): Driver( nCaseId )
{

}

int IT_05_faceDetectCapture_04::init()
{
...
/*
void IT_05_faceDetectCapture_04::testCallbackSetLineF( RWNotifyType *pNotifyType, UINT8 *pExtData, UINT32 *pDataLen )
{
...
void IT_05_faceDetectCapture_04::setline()
{
...
void IT_05_faceDetectCapture_04::mySetDetectCfg()
{
	int ret32 = 0;
	DetectCfg cfgData;
...
void IT_05_faceDetectCapture_04::addRegion()
{
	int nCount ; 
	nCount = 4; 
	Point tempPoint1[4];
...
void IT_05_faceDetectCapture_04::writeInt32(char* data, int value)
{
...
void  IT_05_faceDetectCapture_04::myAddFrame()
{
	int ret32 = 0;
	int width = 1920;
	int heigth = 1080;
...
void IT_05_faceDetectCapture_04::initHeatBeat()
{
	int ret32 = 0;
	DetectCfg cfgData;
...
void IT_05_faceDetectCapture_04::initDetectFace()
{
	int ret32 = 0;
	DetectCfg cfgData;
...
int IT_05_faceDetectCapture_04::faceSize(UINT16 faceSizeValue)
{
	int ret32 = 0;
	DetectCfg cfgData;
...
int IT_05_faceDetectCapture_04:: faceDetectCapture(int type)
{
	int ret32 = 0;
	DetectCfg cfgData;
	cfgData.ConfigMask = 0x01;
...
int IT_05_faceDetectCapture_04::run()
{	
	int ret32 = 0;
	int width = 1920;
	int heigth = 1080;
...
int IT_05_faceDetectCapture_04::uninit()
{
	Driver::uninit();
}

IT_05_faceDetectCapture_04::~IT_05_faceDetectCapture_04()
{
...
void IT_05_faceDetectCapture_04::usrCallbackReplyCancalClient2(UINT64 *pReqID,
											  UINT8 *pRet,
											  UINT8 *pReplyData,
											  UINT32 *pDataLen )
{
...
void IT_05_faceDetectCapture_04::usrCallbackReplyRegisterClient2(UINT64 *pReqID,
												UINT8 *pRet,
												UINT8 *pReplyData,
												UINT32 *pDataLen )
{
...
void IT_05_faceDetectCapture_04::usrCallbackNotifyServiceInfo2( RWNotifyType *pNotifyType,
											   UINT8 *pExtData,
											   UINT32 *pDataLen)
{
...
void IT_05_faceDetectCapture_04::usrCallbackNotifyFaceInfo2( RWNotifyType *pNotifyType,
											UINT8 *pExtData,
											UINT32 *pDataLen )
{

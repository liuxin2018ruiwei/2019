/********************************************************************
* Name      :  IT_05_faceDetectCapture_04.h                                  
* Param     :                                                        
* Return    :                                                        
* Describ   :                                                        
* Author    :  liuixn                                         
...
#ifndef IT_05_faceDetectCapture_04_H
#define IT_05_faceDetectCapture_04_H
...
class IT_05_faceDetectCapture_04:public Driver
{
	public: 
		
		IT_05_faceDetectCapture_04( unsigned int nCaseId );
		virtual int init();
		virtual int run();
		int initDetectCfgInfo(int DetectThreshold);
		virtual int uninit();

		virtual ~IT_05_faceDetectCapture_04();
		void initRegion();

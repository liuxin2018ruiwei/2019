...
#ifndef IT_11_faceSizeCtrl_01_H
#define IT_11_faceSizeCtrl_01_H
...
class IT_11_faceSizeCtrl_01:public Driver
{
	public: 
		
		IT_11_faceSizeCtrl_01( unsigned int nCaseId );
		virtual int init();
		virtual int run();
		int initDetectCfgInfo(int DetectThreshold);
		virtual int uninit();

		virtual ~IT_11_faceSizeCtrl_01();
		void initRegion();

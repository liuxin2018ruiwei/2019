...
#ifndef IT_03_faceRegion_08_H
#define IT_03_faceRegion_08_H

#include "Driver.h"


class IT_03_faceRegion_08:public Driver
{
	public: 
		
		IT_03_faceRegion_08( unsigned int nCaseId );
		virtual int init();
		virtual int run();
		int initDetectCfgInfo(int DetectThreshold);
		virtual int uninit();

		virtual ~IT_03_faceRegion_08();
		void initRegion();

/********************************************************************
* Name      :  IT_05_faceDetectCapture_03.h                                  
* Param     :                                                        
* Return    :                                                        
* Describ   :                                                        
* Author    :  liuixn                                         
...
#ifndef IT_05_faceDetectCapture_03_H
#define IT_05_faceDetectCapture_03_H
...
class IT_05_faceDetectCapture_03:public Driver
{
	public: 
		
		IT_05_faceDetectCapture_03( unsigned int nCaseId );
		virtual int init();
		virtual int run();
		int initDetectCfgInfo(int DetectThreshold);
		virtual int uninit();

		virtual ~IT_05_faceDetectCapture_03();
		void initRegion();

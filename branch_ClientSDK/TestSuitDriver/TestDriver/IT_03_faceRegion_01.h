...
#ifndef IT_03_faceRegion_01_H
#define IT_03_faceRegion_01_H

#include "Driver.h"


class IT_03_faceRegion_01:public Driver
{
	public: 
		
		IT_03_faceRegion_01( unsigned int nCaseId );
		virtual int init();
		virtual int run();
		int initDetectCfgInfo(int DetectThreshold);
		virtual int uninit();

		virtual ~IT_03_faceRegion_01();
		void initRegion();

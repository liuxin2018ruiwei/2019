/********************************************************************
* Name      :  IT_05_faceDetectCapture_02.cpp                                  
* Param     :                                                        
* Return    :                                                        
* Describ   :                                                        
* Author    :  Liu Xin                                          
...
int IT_05_faceDetectCapture_02::init_initDetectFaceIF()
{
...
int IT_05_faceDetectCapture_02:: init_pCallBackInfo()
{
...
IT_05_faceDetectCapture_02::IT_05_faceDetectCapture_02(unsigned int nCaseId ): Driver( nCaseId )
{

}

int IT_05_faceDetectCapture_02::init()
{
...
/*
void IT_05_faceDetectCapture_02::testCallbackSetLineF( RWNotifyType *pNotifyType, UINT8 *pExtData, UINT32 *pDataLen )
{
...
void IT_05_faceDetectCapture_02::setline()
{
...
void IT_05_faceDetectCapture_02::mySetDetectCfg()
{
	int ret32 = 0;
	DetectCfg cfgData;
	...
	cfgData.DetectType = 1;
	cfgData.DetectTime = 10;
	ret32 = setDetectConfig(m_TFHandle, &cfgData);
}

void IT_05_faceDetectCapture_02::addRegion()
{
	int nCount ; 
	nCount = 4; 
	Point tempPoint1[4];
...
void IT_05_faceDetectCapture_02::writeInt32(char* data, int value)
{
...
void  IT_05_faceDetectCapture_02::myAddFrame()
{
	int ret32 = 0;
	int width = 1920;
	int heigth = 1080;
...
void IT_05_faceDetectCapture_02::initHeatBeat()
{
	int ret32 = 0;
	DetectCfg cfgData;
...
void IT_05_faceDetectCapture_02::initDetectFace()
{
	int ret32 = 0;
	DetectCfg cfgData;
	...
	cfgData.ConfigMask = 0x11;
	cfgData.DetectType = 1;
	cfgData.FaceCtrl = 0x81;
	printf("\n IT_02_detectFace_01	open detect face \n");
	ret32 = setDetectConfig(m_TFHandle, &cfgData);

}

int IT_05_faceDetectCapture_02::faceSize(UINT16 faceSizeValue)
{
	int ret32 = 0;
	DetectCfg cfgData;
...
int IT_05_faceDetectCapture_02:: faceDetectCapture(int type)
{
	int ret32 = 0;
	DetectCfg cfgData;
	cfgData.ConfigMask = 0x01;
...
int IT_05_faceDetectCapture_02::run()
{	
	int ret32 = 0;
	int width = 1920;
	int heigth = 1080;
...
int IT_05_faceDetectCapture_02::uninit()
{
	Driver::uninit();
}

IT_05_faceDetectCapture_02::~IT_05_faceDetectCapture_02()
{
...
void IT_05_faceDetectCapture_02::usrCallbackReplyCancalClient2(UINT64 *pReqID,
											  UINT8 *pRet,
											  UINT8 *pReplyData,
											  UINT32 *pDataLen )
{
...
void IT_05_faceDetectCapture_02::usrCallbackReplyRegisterClient2(UINT64 *pReqID,
												UINT8 *pRet,
												UINT8 *pReplyData,
												UINT32 *pDataLen )
{
...
void IT_05_faceDetectCapture_02::usrCallbackNotifyServiceInfo2( RWNotifyType *pNotifyType,
											   UINT8 *pExtData,
											   UINT32 *pDataLen)
{
...
void IT_05_faceDetectCapture_02::usrCallbackNotifyFaceInfo2( RWNotifyType *pNotifyType,
											UINT8 *pExtData,
											UINT32 *pDataLen )
{

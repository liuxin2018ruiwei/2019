...
int IT_03_faceRegion_06::init_initDetectFaceIF()
{
...
int IT_03_faceRegion_06:: init_pCallBackInfo()
{
...
IT_03_faceRegion_06::IT_03_faceRegion_06(unsigned int nCaseId ): Driver( nCaseId )
{

}

int IT_03_faceRegion_06::init()
{
...
void testCallbackSetLine6( RWNotifyType *pNotifyType, UINT8 *pExtData, UINT32 *pDataLen )
{
...
void IT_03_faceRegion_06::setline()
{
	CallbackNotifyFunc pFunc = testCallbackSetLine6;
	Line line3;
	line3.Head.X = 0;
	line3.Head.Y = 20;
	line3.End.X = 1000;
...
void IT_03_faceRegion_06::mySetDetectCfg()
{
	int ret32 = 0;
	DetectCfg cfgData;
...
void IT_03_faceRegion_06::addRegion()
{
	int nCount ; 
	nCount = 4; 
	Point tempPoint1[4];
...
void IT_03_faceRegion_06::writeInt32(char* data, int value)
{
...
void  IT_03_faceRegion_06::myAddFrame()
{
	int ret32 = 0;
	int width = 1920;
	int heigth = 1080;
...
int IT_03_faceRegion_06::run()
{	
	printf("IT_03_faceRegion_06\n");
	int ret32 = 0;
	int width = 1920;
	int heigth = 1080;
	mySetDetectCfg();
	...
	tempPoint1[3].X = 1300;	
	tempPoint1[3].Y = 1000;	
	addShieldRegion( m_TFHandle, (Point *)(&tempPoint1),  nCount );
...
int IT_03_faceRegion_06::uninit()
{
	Driver::uninit();
}

IT_03_faceRegion_06::~IT_03_faceRegion_06()
{
...
void IT_03_faceRegion_06::usrCallbackReplyCancalClient2(UINT64 *pReqID,
											  UINT8 *pRet,
											  UINT8 *pReplyData,
											  UINT32 *pDataLen )
{
...
void IT_03_faceRegion_06::usrCallbackReplyRegisterClient2(UINT64 *pReqID,
												UINT8 *pRet,
												UINT8 *pReplyData,
												UINT32 *pDataLen )
{
...
void IT_03_faceRegion_06::usrCallbackNotifyServiceInfo2( RWNotifyType *pNotifyType,
											   UINT8 *pExtData,
											   UINT32 *pDataLen)
{
...
void IT_03_faceRegion_06::usrCallbackNotifyFaceInfo2( RWNotifyType *pNotifyType,
											UINT8 *pExtData,
											UINT32 *pDataLen )
{

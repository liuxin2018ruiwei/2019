/********************************************************************
* Name      :  IT_15_UpgradeFunction_10.h                                  
* Param     :                                                        
* Return    :                                                        
* Describ   :                                                        
* Author    :  liuixn                                         
...
#ifndef IT_15_UpgradeFunction_10_H
#define IT_15_UpgradeFunction_10_H

#include "Driver.h"


class IT_15_UpgradeFunction_10:public Driver
{
	public: 
		
		IT_15_UpgradeFunction_10( unsigned int nCaseId );
		virtual int init();
		virtual int run();
		int initDetectCfgInfo(int DetectThreshold);
		virtual int uninit();

		virtual ~IT_15_UpgradeFunction_10();
		void initRegion();

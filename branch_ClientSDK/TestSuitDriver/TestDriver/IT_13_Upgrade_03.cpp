...
int IT_13_Upgrade_03::init_initDetectFaceIF()
{
...
int IT_13_Upgrade_03:: init_pCallBackInfo()
{
...
IT_13_Upgrade_03::IT_13_Upgrade_03(unsigned int nCaseId ): Driver( nCaseId )
{

}

int IT_13_Upgrade_03::init()
{
...
void IT_13_Upgrade_03_CallBackUpgrade(UINT64 *pReqID, UINT8 *pRet, UINT8 *pReplyData,UINT32 *pDataLen )
{
	UpgradeReqType getReplyData  =*((UpgradeReqType *) pReplyData);
	printf("2getReplyData = %d\n",getReplyData);
	if(0  == getReplyData)
	{
...
int IT_13_Upgrade_03::upgradeAppCfg()
{
	int ret32 = 0;
	...
	CallbackReplyFunc pFuncTest = IT_13_Upgrade_03_CallBackUpgrade; 
	printf("\n%x\n",pFuncTest);
...
int IT_13_Upgrade_03::upgradeAppPkg()
{
	int ret32 = 0;
...
int IT_13_Upgrade_03::upgradeCamereaQSPI()
{
	int ret32 = 0;
...
int IT_13_Upgrade_03::getpDataCfgInfo( )
{
...
void IT_13_Upgrade_03::qurySoftVersion()
{
...
void IT_13_Upgrade_03::initHeatBeat()
{
	int ret32 = 0;
	DetectCfg cfgData;
...
void IT_13_Upgrade_03::mySetDetectCfg()
{
	int ret32 = 0;
	DetectCfg cfgData;
...
void testCallbackSetLine_IT_13_Upgrade_03( RWNotifyType *pNotifyType, UINT8 *pExtData, UINT32 *pDataLen )
{
...
void IT_13_Upgrade_03::writeInt32(char* data, int value)
{
...
void IT_13_Upgrade_03::setline()
{
	CallbackNotifyFunc pFunc = testCallbackSetLine_IT_13_Upgrade_03;
	Line line3;
	line3.Head.X = 0;
	line3.Head.Y = 440;
	line3.End.X = 1920;
...
int IT_13_Upgrade_03::faceSize(UINT16 faceSizeValue)
{
	int ret32 = 0;
	DetectCfg cfgData;
...
void IT_13_Upgrade_03::initDetectFace()
{
	int ret32 = 0;
	DetectCfg cfgData;
...
void IT_13_Upgrade_03::addRegion()
{
	int nCount ; 
	nCount = 4; 
	Point tempPoint1[4];
...
int IT_13_Upgrade_03:: faceDetectCapture(int type)
{
	int ret32 = 0;
	DetectCfg cfgData;
	cfgData.ConfigMask = 0x01;
...
int IT_13_Upgrade_03::setFaceCtrl(UINT8 faceData)
{
	int ret32 = 0;
	DetectCfg cfgData;
...
void IT_13_Upgrade_03::backGroundPicSwith(UINT8 data)
{
	int ret32 = 0;
	DetectCfg cfgData;
...
int IT_13_Upgrade_03::faceDetectThreshold(int value)
{
	int ret32 = 0;
	DetectCfg cfgData;
...
void  IT_13_Upgrade_03::myAddFrame()
{
	int ret32 = 0;
	int width = 1920;
	int heigth = 1080;
...
int IT_13_Upgrade_03::uninit()
{
	Driver::uninit();
}

IT_13_Upgrade_03::~IT_13_Upgrade_03()
{
...
void IT_13_Upgrade_03::usrCallbackReplyCancalClient1(UINT64 *pReqID,
											  UINT8 *pRet,
											  UINT8 *pReplyData,
											  UINT32 *pDataLen )
{
...
void IT_13_Upgrade_03::usrCallbackReplyRegisterClient1(UINT64 *pReqID,
												UINT8 *pRet,
												UINT8 *pReplyData,
												UINT32 *pDataLen )
{
...
void IT_13_Upgrade_03::usrCallbackNotifyServiceInfo1( RWNotifyType *pNotifyType,
											   UINT8 *pExtData,
											   UINT32 *pDataLen)
{
	//printf("---the notify CLIENT INFO type=%d, datalen=%d", *pNotifyType, *pDataLen );
}
void IT_13_Upgrade_03::usrCallbackNotifyFaceInfo1( RWNotifyType *pNotifyType,
											UINT8 *pExtData,
											UINT32 *pDataLen )
{

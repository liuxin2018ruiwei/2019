...
#ifndef IT_04_faceSize_03_H
#define IT_04_faceSize_03_H

#include "Driver.h"


class IT_04_faceSize_03:public Driver
{
	public: 
		
		IT_04_faceSize_03( unsigned int nCaseId );
		virtual int init();
		virtual int run();
		int initDetectCfgInfo(int DetectThreshold);
		virtual int uninit();

		virtual ~IT_04_faceSize_03();
		void initRegion();
